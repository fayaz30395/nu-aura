...
public interface LeaveRequestRepository extends JpaRepository<LeaveRequest, UUID> {
    ...
    Page<LeaveRequest> findAllByTenantIdAndStatus(UUID tenantId, LeaveRequest.LeaveRequestStatus status, Pageable pageable);
    ...
    Long countByTenantIdAndStatusAndEmployeeIdIn(@Param("tenantId") UUID tenantId, @Param("status") LeaveRequest.LeaveRequestStatus status, @Param("employeeIds") List<UUID> employeeIds);
    ...
    Long countByTenantIdAndStatusAndEmployeeId(UUID tenantId, LeaveRequest.LeaveRequestStatus status, UUID employeeId);
