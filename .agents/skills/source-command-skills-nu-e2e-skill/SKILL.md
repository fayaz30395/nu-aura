---
name: "source-command-skills-nu-e2e-skill"
...
# source-command-skills-nu-e2e-skill

Use this skill when the user asks to run the migrated source command `skills-nu-e2e-SKILL`.
