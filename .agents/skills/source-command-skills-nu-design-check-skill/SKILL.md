---
name: "source-command-skills-nu-design-check-skill"
...
# source-command-skills-nu-design-check-skill

Use this skill when the user asks to run the migrated source command `skills-nu-design-check-SKILL`.
