---
name: "source-command-skills-nu-page-skill"
...
# source-command-skills-nu-page-skill

Use this skill when the user asks to run the migrated source command `skills-nu-page-SKILL`.
