...
- **Permission Normalization**: usePermissions() normalizes 3-format codes (HRMS:MODULE:ACTION →
  MODULE:ACTION)
...
1. **Add Deprecation Notice**: Mark MANAGER role as deprecated in Roles constant (already noted in
   code)
