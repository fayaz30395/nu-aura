...
- **Data exposed:** Names, emails, employee codes, designations, departments, levels, managers, joining dates
...
- **Status:** ✅ PASS — All MY SPACE items (My Dashboard, My Profile, My Payslips, My Attendance, My Leaves, My Documents) have NO `requiredPermission` — correct per architecture
