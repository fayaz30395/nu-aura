...
import static com.nulogic.api.resourcemanagement.dto.ApprovalDTOs.*;
...
public class ResourceManagementController {
    ...
    public ResponseEntity<List<com.nulogic.api.resourcemanagement.dto.AvailabilityDTOs.Holiday>> getHolidays(
            @RequestParam LocalDate startDate,
            @RequestParam LocalDate endDate,
