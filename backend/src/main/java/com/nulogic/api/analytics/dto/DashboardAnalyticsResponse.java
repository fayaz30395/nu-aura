package com.nulogic.api.analytics.dto;
...
public class DashboardAnalyticsResponse {
    ...
    private String viewLabel; // Human-readable label like "Organization View", "Team View", "Personal View"
    private Long teamSize;    // For managers: number of reportees; for employees: 1
