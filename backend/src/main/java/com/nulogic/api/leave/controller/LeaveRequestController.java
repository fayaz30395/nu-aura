...
public class LeaveRequestController {
    ...
    public ResponseEntity<Page<LeaveRequestResponse>> getLeaveRequestsByStatus(
        ...
        String permission = com.nulogic.common.security.SecurityContext.hasPermission(Permission.LEAVE_VIEW_ALL)
                ? Permission.LEAVE_VIEW_ALL
                : Permission.LEAVE_VIEW_TEAM;
    ...
    public ResponseEntity<Page<LeaveRequestResponse>> getLeaveRequests(
        ...
        String permission;
        if (com.nulogic.common.security.SecurityContext.hasPermission(Permission.LEAVE_VIEW_ALL)) {
            permission = Permission.LEAVE_VIEW_ALL;
        } else if (com.nulogic.common.security.SecurityContext.hasPermission(Permission.LEAVE_VIEW_TEAM)) {
    ...
    private String determineViewPermission() {
        ...
        com.nulogic.domain.user.RoleScope manageScope = SecurityContext.getPermissionScope(Permission.LEAVE_MANAGE);
        if (manageScope != null) {
    ...
    private void validateEmployeeAccess(UUID targetEmployeeId, String permission) {
        ...
        com.nulogic.domain.user.RoleScope scope = SecurityContext.getPermissionScope(permission);
        if (scope == null) {
