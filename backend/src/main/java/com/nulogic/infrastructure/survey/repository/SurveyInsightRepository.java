package com.nulogic.infrastructure.survey.repository;

import com.nulogic.domain.survey.SurveyInsight;
...
public interface SurveyInsightRepository extends JpaRepository<SurveyInsight, UUID> {
    ...
    List<SurveyInsight> findByCategory(
            @Param("tenantId") UUID tenantId,
            @Param("category") com.nulogic.domain.survey.SurveyQuestion.EngagementCategory category);
