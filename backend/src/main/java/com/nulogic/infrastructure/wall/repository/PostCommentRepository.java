...
import com.nulogic.domain.wall.model.PostComment;
...
public interface PostCommentRepository extends JpaRepository<PostComment, UUID> {
    ...
    @Query("SELECT COUNT(c) FROM PostComment c WHERE c.parentComment.id = :parentCommentId AND c.isDeleted = false")
