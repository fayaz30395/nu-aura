...
public class KafkaConfig {
     ...
     */
    @Bean
    public ConsumerFactory<String, com.nulogic.infrastructure.kafka.events.FluenceContentEvent> fluenceContentEventConsumerFactory() {
        return createConsumerFactory(com.nulogic.infrastructure.kafka.events.FluenceContentEvent.class, KafkaTopics.GROUP_FLUENCE_SEARCH);
    }
     ...
     */
    @Bean
    public KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<String, com.nulogic.infrastructure.kafka.events.FluenceContentEvent>> fluenceContentEventListenerContainerFactory() {
     ...
     */
    @Bean
    public ConsumerFactory<String, com.nulogic.infrastructure.kafka.events.PayrollProcessingEvent> payrollProcessingEventConsumerFactory() {
        return createConsumerFactory(
                com.nulogic.infrastructure.kafka.events.PayrollProcessingEvent.class,
     ...
     */
    @Bean
    public KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<String, com.nulogic.infrastructure.kafka.events.PayrollProcessingEvent>> payrollProcessingEventListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, com.nulogic.infrastructure.kafka.events.PayrollProcessingEvent> factory =
