...
import com.nulogic.domain.performance.Feedback360Cycle.CycleStatus;
...
public interface Feedback360CycleRepository extends JpaRepository<Feedback360Cycle, UUID> {
    ...
    @Query("SELECT c FROM Feedback360Cycle c WHERE c.tenantId = :tenantId AND c.status IN (com.nulogic.domain.performance.Feedback360Cycle.CycleStatus.IN_PROGRESS, com.nulogic.domain.performance.Feedback360Cycle.CycleStatus.NOMINATION_OPEN)")
