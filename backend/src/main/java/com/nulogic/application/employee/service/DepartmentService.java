...
import com.nulogic.api.employee.dto.DepartmentRequest;
import com.nulogic.api.employee.dto.DepartmentResponse;
...
public class DepartmentService {
    ...
    @Transactional(readOnly = true)
    @Cacheable(value = CacheConfig.DEPARTMENTS, key = "'active:' + T(com.nulogic.common.security.TenantContext).requireCurrentTenant()")
