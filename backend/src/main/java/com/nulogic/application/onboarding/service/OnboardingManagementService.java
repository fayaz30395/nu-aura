package com.nulogic.application.onboarding.service;
...
import com.nulogic.infrastructure.onboarding.repository.OnboardingChecklistTemplateRepository;
import com.nulogic.infrastructure.onboarding.repository.OnboardingProcessRepository;
import com.nulogic.infrastructure.onboarding.repository.OnboardingTaskRepository;
import com.nulogic.infrastructure.onboarding.repository.OnboardingTemplateTaskRepository;
...
public class OnboardingManagementService implements ApprovalCallbackHandler {
    ...
    private void generateTasksFromRoleTemplates(OnboardingProcess process, UUID tenantId) {
        List<com.nulogic.domain.onboarding.OnboardingTaskTemplate> templates =
