...
import com.nulogic.api.auth.dto.SamlConfigRequest;
import com.nulogic.api.auth.dto.SamlConfigResponse;
import com.nulogic.api.auth.dto.SamlTestConnectionResponse;
...
public class SamlConfigurationService {
    ...
    private void validateRequest(SamlConfigRequest request) {
        ...
        if (request.getMetadataUrl() != null && !request.getMetadataUrl().isBlank()) {
            ...
            try {
                com.nulogic.common.validation.SsrfProtectionUtils.validateUrlSafety(request.getMetadataUrl());
    ...
    private boolean testMetadataUrl(String metadataUrl) {
        ...
        com.nulogic.common.validation.SsrfProtectionUtils.validateUrlSafety(metadataUrl);
