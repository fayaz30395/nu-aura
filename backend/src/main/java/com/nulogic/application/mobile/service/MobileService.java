...
import com.nulogic.api.mobile.dto.MobileDashboardResponse;
import com.nulogic.application.announcement.service.AnnouncementService;
import com.nulogic.application.attendance.service.HolidayService;
    ...
    private List<MobileDashboardResponse.EmployeeReminder> getEmployeeReminders(
        ...
        try {
            ...
            if (currentEmployeeId != null) {
                ...
                try {
                    List<com.nulogic.api.employee.dto.EmployeeResponse> subordinates =
