...
import com.nulogic.domain.knowledge.DocumentTemplate;
...
import com.nulogic.infrastructure.knowledge.repository.TemplateInstantiationRepository;
...
public class DocumentTemplateService {
    ...
    public DocumentTemplate updateTemplate(UUID templateId, DocumentTemplate templateData) {
        ...
        recordActivity(tenantId, com.nulogic.common.security.SecurityContext.getCurrentUserId(), "UPDATED", updated);
        return updated;
    }
