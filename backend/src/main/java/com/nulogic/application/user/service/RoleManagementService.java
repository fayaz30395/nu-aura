...
import com.nulogic.infrastructure.user.repository.CustomScopeTargetRepository;
...
public class RoleManagementService {
    ...
    public RoleResponse createRole(CreateRoleRequest request) {
        ...
        if (request.getPermissionCodes() != null && !request.getPermissionCodes().isEmpty()) {
            ...
            for (Permission perm : permissions) {
                role.addPermission(perm, com.nulogic.domain.user.RoleScope.GLOBAL);
            }
        }
        ...
        auditLogService.logAction("ROLE", savedRole.getId(),
                com.nulogic.domain.audit.AuditLog.AuditAction.CREATE,
    ...
    public void deleteRole(UUID roleId) {
        ...
        auditLogService.logAction("ROLE", role.getId(),
                com.nulogic.domain.audit.AuditLog.AuditAction.DELETE,
    ...
    public UserResponse getUserById(UUID userId) {
        com.nulogic.domain.user.User user = userRepository.findByIdWithRolesAndPermissions(userId)
    ...
    public List<UserResponse> getAllUsers() {
        UUID tenantId = SecurityContext.getCurrentTenantId();
        List<com.nulogic.domain.user.User> users = userRepository.findByTenantId(tenantId); // Assuming this method exists
    ...
    public Page<UserResponse> getAllUsers(Pageable pageable) {
        UUID tenantId = SecurityContext.getCurrentTenantId();
        Page<com.nulogic.domain.user.User> usersPage = userRepository.findByTenantId(tenantId, pageable);
    ...
    public UserResponse assignRolesToUser(UUID userId, AssignRolesRequest request) {
        ...
        com.nulogic.domain.user.User user = userRepository.findByIdAndTenantId(userId, tenantId)
    ...
    private UserResponse mapUserToResponse(com.nulogic.domain.user.User user) {
