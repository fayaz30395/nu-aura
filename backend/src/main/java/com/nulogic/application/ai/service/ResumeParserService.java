...
import com.nulogic.api.recruitment.dto.ai.AIResumeParseDTO;
 ...
 * configured, this service throws {@link com.nulogic.common.exception.BusinessException}
...
public class ResumeParserService {
    ...
    public ResumeParseResponse parseResumeFromUrl(String resumeUrl) {
        ...
        try {
            ...
            com.nulogic.common.validation.SsrfProtectionUtils.validateUrlSafety(resumeUrl);
     ...
     * any 3xx redirect's Location through {@link com.nulogic.common.validation.SsrfProtectionUtils}.
     *
    ...
    private java.net.HttpURLConnection openConnectionWithManualRedirects(java.net.URL initialUrl, int maxHops)
        ...
        for (int hop = 0; hop < maxHops; hop++) {
            ...
            if (status >= 300 && status < 400) {
                ...
                try {
                    com.nulogic.common.validation.SsrfProtectionUtils.validateUrlSafety(next.toString());
                } catch (com.nulogic.common.exception.BusinessException ssrf) {
