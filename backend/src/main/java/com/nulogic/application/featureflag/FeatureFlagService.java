package com.nulogic.application.featureflag;

import com.nulogic.common.config.CacheConfig;
import com.nulogic.common.security.SecurityContext;
import com.nulogic.domain.featureflag.FeatureFlag;
import com.nulogic.infrastructure.featureflag.FeatureFlagRepository;
...
public class FeatureFlagService {
    ...
    @Cacheable(value = CacheConfig.FEATURE_FLAGS, key = "#featureKey + '_' + T(com.nulogic.common.security.SecurityContext).getCurrentTenantId()")
     ...
     */
    @Transactional
    @CacheEvict(value = CacheConfig.FEATURE_FLAGS, key = "#featureKey + '_' + T(com.nulogic.common.security.SecurityContext).getCurrentTenantId()")
