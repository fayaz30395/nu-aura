...
@Table(name = "mileage_policies", indexes = {
        @Index(name = "idx_mileage_policy_tenant", columnList = "tenant_id"),
        @Index(name = "idx_mileage_policy_tenant_active", columnList = "tenant_id,is_active")
}, uniqueConstraints = {
        @UniqueConstraint(name = "uk_mileage_policy_tenant_name", columnNames = {"tenant_id", "name"})
})
@Getter
@Setter
@NoArgsConstructor
