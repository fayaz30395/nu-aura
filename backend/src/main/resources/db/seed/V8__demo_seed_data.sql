...
VALUES ('00000000-0000-0000-0000-000000000001', 'acme', 'Acme Corp', 'ACTIVE', NOW(), NOW(),
        false) ON CONFLICT (id) DO NOTHING;

-- ─── Departments ─────────────────────────────────────────────────────────────
INSERT INTO departments (id, tenant_id, name, code, is_active, created_at, updated_at, is_deleted)
VALUES ('10000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', 'Engineering', 'ENG', true,
        NOW(), NOW(), false),
       ('10000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000001', 'Product', 'PROD', true, NOW(),
        NOW(), false),
       ('10000000-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000001', 'Human Resources', 'HR', true,
...
INSERT INTO users (id, tenant_id, email, first_name, last_name, password_hash, status, created_at, updated_at,
                   is_deleted)
VALUES ('61000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', 'sarah.chen@acme.example.com',
        'Sarah', 'Chen', '$2a$10$demoHashPlaceholder001', 'ACTIVE', NOW(), NOW(), false),
       ('61000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000001',
        'michael.rodriguez@acme.example.com', 'Michael', 'Rodriguez', '$2a$10$demoHashPlaceholder002', 'ACTIVE', NOW(),
        NOW(), false),
       ('61000000-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000001', 'priya.patel@acme.example.com',
        'Priya', 'Patel', '$2a$10$demoHashPlaceholder003', 'ACTIVE', NOW(), NOW(), false),
       ('61000000-0000-0000-0000-000000000004', '00000000-0000-0000-0000-000000000001', 'alex.kim@acme.example.com',
        'Alex', 'Kim', '$2a$10$demoHashPlaceholder004', 'ACTIVE', NOW(), NOW(), false),
       ('61000000-0000-0000-0000-000000000005', '00000000-0000-0000-0000-000000000001', 'jamie.liu@acme.example.com',
        'Jamie', 'Liu', '$2a$10$demoHashPlaceholder005', 'ACTIVE', NOW(), NOW(), false) ON CONFLICT (id) DO NOTHING;
...
INSERT INTO leave_types (id, tenant_id, leave_name, leave_code, annual_quota, is_paid, is_active, created_at,
...
VALUES ('30000000-0000-0000-0000-000000000001',
       ...
       ('30000000-0000-0000-0000-000000000002',
        '00000000-0000-0000-0000-000000000001',
        'Sick Leave', 'SL', 12.00, true, true, NOW(), NOW(), false) ON CONFLICT (id) DO NOTHING;

-- ─── Projects ────────────────────────────────────────────────────────────────
-- Actual column names: project_code (not code); status enum: IN_PROGRESS not ACTIVE; priority required NOT NULL
INSERT INTO projects (id, tenant_id, name, project_code, status, priority, start_date, created_at, updated_at,
                      is_deleted)
VALUES ('40000000-0000-0000-0000-000000000001',
       ...
       ('40000000-0000-0000-0000-000000000002',
        '00000000-0000-0000-0000-000000000001',
        'Internal Tools', 'INTTOOLS', 'IN_PROGRESS', 'MEDIUM', '2024-06-01', NOW(), NOW(),
        false) ON CONFLICT (id) DO NOTHING;

-- ─── Project employee assignments ─────────────────────────────────────────────
-- ProjectEmployee uses is_active (BOOLEAN) not status (String)
INSERT INTO project_employees (id, tenant_id, project_id, employee_id, role, allocation_percentage, start_date,
...
VALUES ('50000000-0000-0000-0000-000000000001',
       ...
       ('50000000-0000-0000-0000-000000000003',
        ...
        '40000000-0000-0000-0000-000000000002',
        '20000000-0000-0000-0000-000000000002',
        'DEVELOPER', 40, '2024-06-01', true, NOW(), NOW(), false) ON CONFLICT (id) DO NOTHING;
