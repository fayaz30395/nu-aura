...
BEGIN
    ...
    INSERT INTO workflow_definitions (id, tenant_id, name, entity_type, workflow_type, workflow_version, is_active, is_default, allow_parallel_approval)
    VALUES (v_leave_wf_id, v_tenant_id, 'Default Leave Approval', 'LEAVE_REQUEST', 'SEQUENTIAL', 1, TRUE, TRUE, FALSE);
    ...
    INSERT INTO workflow_definitions (id, tenant_id, name, entity_type, workflow_type, workflow_version, is_active, is_default, allow_parallel_approval)
    VALUES (v_expense_wf_id, v_tenant_id, 'Default Expense Approval', 'EXPENSE_CLAIM', 'SEQUENTIAL', 1, TRUE, TRUE, FALSE);
    ...
    INSERT INTO workflow_definitions (id, tenant_id, name, entity_type, workflow_type, workflow_version, is_active, is_default, allow_parallel_approval)
    VALUES (v_asset_wf_id, v_tenant_id, 'Default Asset Request Approval', 'ASSET_REQUEST', 'SEQUENTIAL', 1, TRUE, TRUE, FALSE);
    ...
    INSERT INTO workflow_definitions (id, tenant_id, name, entity_type, workflow_type, workflow_version, is_active, is_default, allow_parallel_approval)
    VALUES (v_travel_wf_id, v_tenant_id, 'Default Travel Approval', 'TRAVEL_REQUEST', 'SEQUENTIAL', 1, TRUE, TRUE, FALSE);
    ...
    INSERT INTO workflow_definitions (id, tenant_id, name, entity_type, workflow_type, workflow_version, is_active, is_default, allow_parallel_approval)
    VALUES (v_loan_wf_id, v_tenant_id, 'Default Loan Approval', 'LOAN_REQUEST', 'SEQUENTIAL', 1, TRUE, TRUE, FALSE);
    ...
    INSERT INTO workflow_definitions (id, tenant_id, name, entity_type, workflow_type, workflow_version, is_active, is_default, allow_parallel_approval)
    VALUES (v_onboarding_wf_id, v_tenant_id, 'Default Onboarding Approval', 'ONBOARDING', 'SEQUENTIAL', 1, TRUE, TRUE, FALSE);
    ...
    INSERT INTO workflow_definitions (id, tenant_id, name, entity_type, workflow_type, workflow_version, is_active, is_default, allow_parallel_approval)
    VALUES (v_timesheet_wf_id, v_tenant_id, 'Default Timesheet Approval', 'TIMESHEET', 'SEQUENTIAL', 1, TRUE, TRUE, FALSE);
