...
BEGIN
    ...
    INSERT INTO workflow_definitions (
        ...
        v_leave_wf_id, v_tenant_id, 'Default Leave Approval', 'LEAVE_REQUEST', 'SEQUENTIAL', 1,
    ...
    INSERT INTO workflow_definitions (
        ...
        v_expense_wf_id, v_tenant_id, 'Default Expense Approval', 'EXPENSE_CLAIM', 'SEQUENTIAL', 1,
        TRUE, TRUE, FALSE, FALSE, FALSE,
        48, 72, FALSE,
        TRUE, FALSE, TRUE, TRUE,
        FALSE, v_now, v_now
    ...
    INSERT INTO workflow_definitions (
        ...
        v_asset_wf_id, v_tenant_id, 'Default Asset Request Approval', 'ASSET_REQUEST', 'SEQUENTIAL', 1,
        TRUE, TRUE, FALSE, FALSE, FALSE,
        48, 72, FALSE,
        TRUE, FALSE, TRUE, TRUE,
        FALSE, v_now, v_now
    ...
    INSERT INTO workflow_definitions (
        ...
        v_travel_wf_id, v_tenant_id, 'Default Travel Approval', 'TRAVEL_REQUEST', 'SEQUENTIAL', 1,
        TRUE, TRUE, FALSE, FALSE, FALSE,
        48, 72, FALSE,
        TRUE, FALSE, TRUE, TRUE,
        FALSE, v_now, v_now
    ...
    INSERT INTO workflow_definitions (
        ...
        v_loan_wf_id, v_tenant_id, 'Default Loan Approval', 'LOAN_REQUEST', 'SEQUENTIAL', 1,
        TRUE, TRUE, FALSE, FALSE, FALSE,
        48, 72, FALSE,
        TRUE, FALSE, TRUE, TRUE,
        FALSE, v_now, v_now
    ...
    INSERT INTO workflow_definitions (
        ...
        v_onboarding_wf_id, v_tenant_id, 'Default Onboarding Approval', 'ONBOARDING', 'SEQUENTIAL', 1,
        TRUE, TRUE, FALSE, FALSE, FALSE,
        48, 72, FALSE,
        TRUE, FALSE, TRUE, TRUE,
        FALSE, v_now, v_now
    ...
    INSERT INTO workflow_definitions (
        ...
        v_timesheet_wf_id, v_tenant_id, 'Default Timesheet Approval', 'TIMESHEET', 'SEQUENTIAL', 1,
        TRUE, TRUE, FALSE, FALSE, FALSE,
        48, 72, FALSE,
        TRUE, FALSE, TRUE, TRUE,
        FALSE, v_now, v_now
