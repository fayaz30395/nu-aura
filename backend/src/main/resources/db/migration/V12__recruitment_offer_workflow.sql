...
COMMENT ON COLUMN workflow_definitions.entity_type IS 'Supported types: LEAVE_REQUEST, EXPENSE_CLAIM, TRAVEL_REQUEST, ASSET_REQUEST, LOAN_REQUEST, SALARY_ADVANCE, TIMESHEET, OVERTIME, ONBOARDING, OFFBOARDING, LETTER_REQUEST, REGULARIZATION, COMP_OFF, WORK_FROM_HOME, RECRUITMENT_OFFER, CUSTOM';
