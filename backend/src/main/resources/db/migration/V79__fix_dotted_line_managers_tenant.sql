...
UPDATE employees
SET dotted_line_manager1_id = '48000000-e001-0000-0000-000000000005', -- Gokul R (Technology Lead)
...
UPDATE employees
SET dotted_line_manager1_id = '48000000-e001-0000-0000-000000000003', -- Mani S (Team Lead)
    updated_at              = NOW()
...
UPDATE employees
SET dotted_line_manager1_id = '48000000-e001-0000-0000-000000000000', -- Fayaz M (CEO)
    updated_at              = NOW()
...
UPDATE employees
SET dotted_line_manager1_id = '48000000-e001-0000-0000-000000000007', -- Jagadeesh N (HR Manager)
    updated_at              = NOW()
...
ALTER TABLE project_members
  ADD CONSTRAINT project_members_role_check
    CHECK (role IN
           ('PROJECT_MANAGER', 'TEAM_LEAD', 'TECHNOLOGY_LEAD', 'DEVELOPER', 'SENIOR_DEVELOPER', 'JUNIOR_DEVELOPER',
            'QA_ENGINEER', 'DESIGNER', 'BUSINESS_ANALYST', 'ARCHITECT', 'CONSULTANT', 'MEMBER'));

-- ============================================================
-- 4. Update Saran's project allocation role to TECHNOLOGY_LEAD
-- ============================================================
UPDATE project_members
SET role                  = 'TECHNOLOGY_LEAD',
