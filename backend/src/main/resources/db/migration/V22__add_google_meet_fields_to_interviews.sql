...
COMMENT
ON COLUMN interviews.google_meet_link IS 'Auto-generated Google Meet video link';
COMMENT
ON COLUMN interviews.google_calendar_event_id IS 'Google Calendar event ID for sync/update/delete';
