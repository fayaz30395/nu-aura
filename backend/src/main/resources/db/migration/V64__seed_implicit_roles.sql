...
SELECT '660e8400-e29b-41d4-a716-446655440001',
...
WHERE r.code = 'MANAGER'
  AND r.tenant_id = '660e8400-e29b-41d4-a716-446655440001' ON CONFLICT (tenant_id, condition_type, target_role_id) DO NOTHING;
...
INSERT INTO approval_escalation_config (tenant_id, workflow_definition_id, timeout_hours, escalation_type,
                                        max_escalations)
SELECT '660e8400-e29b-41d4-a716-446655440001',
       wd.id,
       48,
...
WHERE wd.tenant_id = '660e8400-e29b-41d4-a716-446655440001'
  AND wd.entity_type IN ('LEAVE_REQUEST', 'EXPENSE_CLAIM') ON CONFLICT (tenant_id, workflow_definition_id) DO NOTHING;
