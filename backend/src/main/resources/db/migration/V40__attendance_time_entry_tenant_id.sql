...
ALTER TABLE attendance_time_entries
  ADD COLUMN IF NOT EXISTS tenant_id UUID;

-- Step 2: Backfill from parent attendance_records
UPDATE attendance_time_entries ate
SET tenant_id = ar.tenant_id FROM attendance_records ar
...
CREATE
POLICY attendance_time_entries_allow_all
  ON attendance_time_entries AS PERMISSIVE FOR ALL USING (true);

CREATE
POLICY attendance_time_entries_tenant_rls
