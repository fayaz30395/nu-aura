...
CREATE
EXTENSION IF NOT EXISTS "pg_trgm";  -- For trigram similarity searches
...
(
  ...
  CONSTRAINT fk_wiki_spaces_created_by FOREIGN KEY
(
  created_by
) REFERENCES users
(
  ...
  CONSTRAINT fk_wiki_spaces_updated_by FOREIGN KEY
(
  updated_by
) REFERENCES users
(
...
COMMENT
ON TABLE wiki_spaces IS 'Wiki spaces for organizing pages hierarchically';
COMMENT
ON COLUMN wiki_spaces.slug IS 'URL-friendly identifier for the space';
COMMENT
ON COLUMN wiki_spaces.visibility IS 'Access level: PUBLIC, ORGANIZATION, TEAM, PRIVATE, RESTRICTED';
...
(
  ...
  CONSTRAINT fk_wiki_pages_space FOREIGN KEY
(
  space_id
) REFERENCES wiki_spaces
(
  id
) ON DELETE CASCADE,
  CONSTRAINT fk_wiki_pages_parent FOREIGN KEY
(
  parent_page_id
...
(
  ...
  ON DELETE SET NULL,
  CONSTRAINT fk_wiki_pages_created_by FOREIGN KEY
(
  created_by
) REFERENCES users
(
  ...
  CONSTRAINT fk_wiki_pages_updated_by FOREIGN KEY
(
  updated_by
) REFERENCES users
(
...
COMMENT
ON TABLE wiki_pages IS 'Wiki pages with hierarchical structure and full-text search';
COMMENT
ON COLUMN wiki_pages.content IS 'Rich content stored as JSONB (editor state)';
...
(
  ...
  created_by UUID,
  CONSTRAINT fk_wiki_page_versions_page FOREIGN KEY
(
  page_id
) REFERENCES wiki_pages
(
  ...
  CONSTRAINT fk_wiki_page_versions_created_by FOREIGN KEY
(
  created_by
) REFERENCES users
(
...
COMMENT
ON TABLE wiki_page_versions IS 'Audit trail of wiki page changes';
...
(
  ...
  like_count INT NOT NULL DEFAULT 0,
  is_pinned BOOLEAN NOT NULL DEFAULT FALSE,
  CONSTRAINT fk_wiki_page_comments_page FOREIGN KEY
(
  page_id
) REFERENCES wiki_pages
(
  ...
  CONSTRAINT fk_wiki_page_comments_parent FOREIGN KEY
(
  parent_comment_id
) REFERENCES wiki_page_comments
(
  id
)
  ON DELETE CASCADE,
  CONSTRAINT fk_wiki_page_comments_created_by FOREIGN KEY
(
  created_by
) REFERENCES users
(
...
COMMENT
ON TABLE wiki_page_comments IS 'Comments and discussions on wiki pages';
...
(
  50
) NOT NULL DEFAULT 'COMMENTS' CHECK
(
  watch_type
  IN
(
...
(
  ...
  CONSTRAINT fk_wiki_page_watches_page FOREIGN KEY
(
  page_id
) REFERENCES wiki_pages
(
  ...
  CONSTRAINT fk_wiki_page_watches_user FOREIGN KEY
(
  user_id
) REFERENCES users
(
...
COMMENT
ON TABLE wiki_page_watches IS 'User subscriptions to wiki page updates';
...
(
  ...
  CONSTRAINT fk_blog_categories_created_by FOREIGN KEY
(
  created_by
) REFERENCES users
(
  ...
  CONSTRAINT fk_blog_categories_updated_by FOREIGN KEY
(
  updated_by
) REFERENCES users
(
...
COMMENT
ON TABLE blog_categories IS 'Blog post categories';
...
(
  ...
  CONSTRAINT fk_blog_posts_category FOREIGN KEY
(
  category_id
...
(
  ...
  CONSTRAINT fk_blog_posts_created_by FOREIGN KEY
(
  created_by
) REFERENCES users
(
  ...
  CONSTRAINT fk_blog_posts_updated_by FOREIGN KEY
(
  updated_by
) REFERENCES users
(
  ...
  CONSTRAINT fk_blog_posts_published_by FOREIGN KEY
(
  published_by
) REFERENCES users
(
...
COMMENT
ON TABLE blog_posts IS 'Blog articles with rich content and metadata';
COMMENT
ON COLUMN blog_posts.content IS 'Rich content stored as JSONB (editor state)';
-- TODO: Uncomment once search_vector column is restored
...
(
  ...
  approved_by UUID,
  CONSTRAINT fk_blog_comments_post FOREIGN KEY
(
  post_id
...
(
  ...
  CONSTRAINT fk_blog_comments_parent FOREIGN KEY
(
  parent_comment_id
...
(
  ...
  ON DELETE CASCADE,
  CONSTRAINT fk_blog_comments_created_by FOREIGN KEY
(
  created_by
) REFERENCES users
(
  ...
  CONSTRAINT fk_blog_comments_approved_by FOREIGN KEY
(
  approved_by
) REFERENCES users
(
...
COMMENT
ON TABLE blog_comments IS 'Comments on blog posts with moderation support';
...
(
  ...
  CONSTRAINT fk_blog_likes_post FOREIGN KEY
(
  post_id
) REFERENCES blog_posts
(
  ...
  CONSTRAINT fk_blog_likes_user FOREIGN KEY
(
  user_id
) REFERENCES users
(
...
COMMENT
ON TABLE blog_likes IS 'Likes on blog posts (denormalized to like_count in blog_posts)';
...
(
  ...
  CONSTRAINT fk_document_templates_created_by FOREIGN KEY
(
  created_by
) REFERENCES users
(
  ...
  CONSTRAINT fk_document_templates_updated_by FOREIGN KEY
(
  updated_by
) REFERENCES users
(
...
COMMENT
ON TABLE document_templates IS 'Reusable document templates with variable substitution';
COMMENT
ON COLUMN document_templates.content IS 'Template content stored as JSONB';
COMMENT
ON COLUMN document_templates.template_variables IS 'JSON array defining template variables';
...
(
  ...
  generated_document_url VARCHAR
(
  500
),
  CONSTRAINT fk_template_instantiations_template FOREIGN KEY
(
  template_id
...
(
  ...
  CONSTRAINT fk_template_instantiations_created_by FOREIGN KEY
(
  created_by
) REFERENCES users
(
  ...
  CONSTRAINT fk_template_instantiations_updated_by FOREIGN KEY
(
  updated_by
) REFERENCES users
(
...
COMMENT
ON TABLE template_instantiations IS 'Documents created by instantiating templates';
...
(
  ...
  uploaded_by UUID,
  CONSTRAINT fk_knowledge_attachments_uploaded_by FOREIGN KEY
(
  uploaded_by
) REFERENCES users
(
...
COMMENT
ON TABLE knowledge_attachments IS 'Files attached to knowledge management content (wiki, blog, templates)';
...
(
  ...
  CONSTRAINT fk_knowledge_views_user FOREIGN KEY
(
  user_id
) REFERENCES users
(
...
COMMENT
ON TABLE knowledge_views IS 'Analytics tracking for wiki pages and blog posts';
...
(
  ...
  searched_by UUID,
  CONSTRAINT fk_knowledge_searches_searched_by FOREIGN KEY
(
  searched_by
) REFERENCES users
(
...
COMMENT
ON TABLE knowledge_searches IS 'Search analytics for knowledge management';
...
(
  ...
  CONSTRAINT fk_wiki_page_approval_tasks_page FOREIGN KEY
(
  page_id
) REFERENCES wiki_pages
(
  ...
  CONSTRAINT fk_wiki_page_approval_tasks_submitted_by FOREIGN KEY
(
  submitted_by
) REFERENCES users
(
  ...
  CONSTRAINT fk_wiki_page_approval_tasks_reviewed_by FOREIGN KEY
(
  reviewed_by
) REFERENCES users
(
...
COMMENT
ON TABLE wiki_page_approval_tasks IS 'Approval workflow integration for wiki pages';
