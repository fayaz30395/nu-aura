...
(
  ...
  CONSTRAINT uc_announcement_reads_announcement_id_employee_id UNIQUE
(
  announcement_id,
  employee_id,
  tenant_id
...
(
  ...
  CONSTRAINT uc_app_roles_code_tenantId UNIQUE
(
  code,
  tenant_id,
  application_id
...
(
  ...
  check_in_source VARCHAR
(
  50
),
  check_out_source VARCHAR
(
  50
),
...
(
  ...
  compensation_risk NUMERIC
(
  5,
  2
),
  engagement_risk NUMERIC
(
  5,
  2
),
  performance_risk NUMERIC
(
  5,
  2
),
  manager_change_risk NUMERIC
(
  5,
  2
),
  promotion_gap_risk NUMERIC
(
  5,
  2
),
  workload_risk NUMERIC
(
  5,
  2
),
  commute_risk NUMERIC
(
  5,
  2
),
...
(
  ...
  salary_adjustment_percent NUMERIC
(
  5,
  2
),
  hiring_freeze BOOLEAN DEFAULT FALSE,
  attrition_rate_adjustment NUMERIC
(
  5,
  2
),
...
(
  ...
  CONSTRAINT uc_candidates_tenant_id_candidate_code UNIQUE
(
  tenant_id,
  candidate_code
)
...
(
  ...
  min_increment_percentage NUMERIC
(
  5,
  2
),
  max_increment_percentage NUMERIC
(
  5,
  2
),
  average_increment_target NUMERIC
(
  5,
  2
),
...
(
  ...
  view_visibility VARCHAR
(
  50
),
  edit_visibility VARCHAR
(
  50
)
  );
...
(
  ...
  CONSTRAINT uc_custom_scope_targets_role_permission_id_target_type UNIQUE
(
  role_permission_id,
  target_type,
  target_id
...
(
  ...
  remarks TEXT,
  CONSTRAINT uc_employee_loans_tenantId_loan_number UNIQUE
(
  tenant_id,
  loan_number
)
...
(
  ...
  base_salary_local NUMERIC
(
  15,
  2
),
  allowances_local NUMERIC
(
  15,
  2
),
  bonuses_local NUMERIC
(
  15,
  2
),
  overtime_local NUMERIC
(
  15,
  2
),
  gross_pay_local NUMERIC
(
  15,
  2
),
  income_tax_local NUMERIC
(
  15,
  2
),
  social_security_local NUMERIC
(
  15,
  2
),
  other_deductions_local NUMERIC
(
  15,
  2
),
  total_deductions_local NUMERIC
(
  15,
  2
),
  net_pay_local NUMERIC
(
  15,
  2
),
  employer_social_security_local NUMERIC
(
  15,
  2
),
  employer_other_contributions_local NUMERIC
(
  15,
  2
),
  total_employer_cost_local NUMERIC
(
  15,
  2
),
...
(
  ...
  gross_pay_base NUMERIC
(
  15,
  2
),
  total_deductions_base NUMERIC
(
  15,
  2
),
  net_pay_base NUMERIC
(
  15,
  2
),
  total_employer_cost_base NUMERIC
(
  15,
  2
),
...
(
  ...
  enrollment_date DATE,
  exit_date DATE,
  vpf_percentage NUMERIC
(
  5,
  2
),
  is_international_worker BOOLEAN DEFAULT FALSE,
  previous_pf_balance NUMERIC
(
  12,
  2
),
...
(
  ...
  is_deleted BOOLEAN NOT NULL DEFAULT FALSE,
  employee_id UUID NOT NULL,
  CONSTRAINT uc_employee_points_employee_id_tenant_id UNIQUE
(
  employee_id,
  tenant_id
)
...
(
  ...
  bonus_status VARCHAR
(
  50
),
  bonus_eligible_date DATE,
  bonus_paid_date DATE,
  bonus_payment_reference VARCHAR
(
  255
),
  processing_notes TEXT
...
(
  ...
  lta_exemption NUMERIC
(
  12,
  2
),
  other_exemptions NUMERIC
(
  12,
  2
),
...
(
  ...
  current_job_role VARCHAR
(
  50
),
  current_department_id UUID,
  current_manager_id UUID,
  current_employment_type VARCHAR
(
  20
),
...
(
  ...
  new_job_role VARCHAR
(
  50
),
  new_department_id UUID,
  new_manager_id UUID,
  new_employment_type VARCHAR
(
  20
),
...
(
  ...
  primary_reason_for_leaving VARCHAR
(
  50
),
...
(
  ...
  CONSTRAINT uc_expense_claims_tenantId_claim_number UNIQUE
(
  tenant_id,
  claim_number
)
...
(
  ...
  CONSTRAINT uc_feature_flags_tenant_id_feature_key UNIQUE
(
  tenant_id,
  feature_key
)
...
(
  ...
  adaptability_rating NUMERIC
(
  3,
  2
),
  work_quality_rating NUMERIC
(
  3,
  2
),
  time_management_rating NUMERIC
(
  3,
  2
),
...
(
  ...
  self_overall_rating NUMERIC
(
  3,
  2
),
  manager_overall_rating NUMERIC
(
  3,
  2
),
  peer_avg_rating NUMERIC
(
  3,
  2
),
  upward_avg_rating NUMERIC
(
  3,
  2
),
...
(
  ...
  avg_adaptability NUMERIC
(
  3,
  2
),
  avg_work_quality NUMERIC
(
  3,
  2
),
  avg_time_management NUMERIC
(
  3,
  2
),
...
(
  ...
  notice_period_recovery NUMERIC
(
  12,
  2
),
...
(
  ...
  asset_damage_deduction NUMERIC
(
  12,
  2
),
...
(
  ...
  benefits_budget NUMERIC
(
  15,
  2
),
  bonus_budget NUMERIC
(
  15,
  2
),
...
(
  ...
  actual_salary_spend NUMERIC
(
  15,
  2
),
  actual_total_spend NUMERIC
(
  15,
  2
),
...
(
  ...
  budgeted_salary NUMERIC
(
  12,
  2
),
  budgeted_benefits NUMERIC
(
  12,
  2
),
...
(
  ...
  total_pages INTEGER,
  CONSTRAINT uc_lms_content_progress_enrollmentId_contentId UNIQUE
(
  enrollment_id,
  content_id,
  tenant_id
...
(
  ...
  CONSTRAINT uc_lms_course_enrollments_courseId_employeeId UNIQUE
(
  course_id,
  employee_id,
  tenant_id
...
(
  ...
  year INTEGER NOT NULL,
  pf_employee_contribution NUMERIC
(
  10,
  2
),
  pf_employer_contribution NUMERIC
(
  10,
  2
),
  eps_contribution NUMERIC
(
  10,
  2
),
  vpf_contribution NUMERIC
(
  10,
  2
),
...
(
  ...
  esi_employee_contribution NUMERIC
(
  10,
  2
),
  esi_employer_contribution NUMERIC
(
  10,
  2
),
...
(
  ...
  CONSTRAINT uc_notification_channel_configs_tenantId_channel UNIQUE
(
  tenant_id,
  channel
)
...
(
  ...
  daily_ot_multiplier NUMERIC
(
  3,
  2
),
  daily_max_ot_hours NUMERIC
(
  5,
  2
),
...
(
  ...
  weekly_ot_multiplier NUMERIC
(
  3,
  2
),
  weekly_max_ot_hours NUMERIC
(
  5,
  2
),
  weekend_ot_multiplier NUMERIC
(
  3,
  2
),
...
(
  ...
  night_shift_ot_multiplier NUMERIC
(
  3,
  2
),
  requires_pre_approval BOOLEAN DEFAULT FALSE,
  auto_approve_limit_hours NUMERIC
(
  5,
  2
),
  ...
  comp_time_multiplier NUMERIC
(
  3,
  2
),
  max_comp_time_balance NUMERIC
(
  5,
  2
),
...
(
  ...
  consecutive_day_multiplier NUMERIC
(
  3,
  2
)
...
(
  ...
  base_income_tax_rate NUMERIC
(
  5,
  2
),
  social_security_employee_rate NUMERIC
(
  5,
  2
),
  social_security_employer_rate NUMERIC
(
  5,
  2
),
...
(
  ...
  employee_esi NUMERIC
(
  10,
  2
),
  employer_esi NUMERIC
(
  10,
  2
),
...
(
  ...
  increment_recommendation NUMERIC
(
  5,
  2
),
...
(
  ...
  CONSTRAINT uc_policy_acknowledgments_policy_id_employee_id UNIQUE
(
  policy_id,
  employee_id,
  policy_version
...
(
  ...
  employee_id UUID NOT NULL,
  CONSTRAINT uc_poll_votes_tenant_id_poll_option_id UNIQUE
(
  tenant_id,
  poll_option_id,
  employee_id
...
(
  ...
  eps_contribution_percentage NUMERIC
(
  5,
  2
),
...
(
  ...
  CONSTRAINT uc_pulse_survey_responses_survey_id_employee_id UNIQUE
(
  survey_id,
  employee_id
)
...
(
  ...
  CONSTRAINT uc_recognition_reactions_recognition_id_employee_id UNIQUE
(
  recognition_id,
  employee_id,
  reaction_type
...
(
  ...
  joining_bonus_percentage NUMERIC
(
  5,
  2
),
  retention_bonus_percentage NUMERIC
(
  5,
  2
),
...
(
  ...
  target_employee_action VARCHAR
(
  20
),
  approver_id UUID,
...
(
  ...
  gap_count INTEGER,
  gap_severity NUMERIC
(
  5,
  2
),
  avg_proficiency_level NUMERIC
(
  3,
  1
),
  required_proficiency_level NUMERIC
(
  3,
  1
),
  proficiency_gap NUMERIC
(
  3,
  1
),
  projected_demand_growth NUMERIC
(
  5,
  2
),
...
(
  ...
  estimated_training_cost NUMERIC
(
  12,
  2
),
  estimated_hiring_cost NUMERIC
(
  12,
  2
),
...
(
  ...
  gaps TEXT,
  notes TEXT,
  CONSTRAINT uc_succession_candidates_succession_plan_id_candidate_id UNIQUE
(
  succession_plan_id,
  candidate_id
)
...
(
  ...
  notes TEXT,
  CONSTRAINT uc_talent_pool_members_talent_pool_id_employee_id UNIQUE
(
  talent_pool_id,
  employee_id
)
...
(
  ...
  sec_80c_life_insurance NUMERIC
(
  15,
  2
),
  sec_80c_elss NUMERIC
(
  15,
  2
),
...
(
  ...
  sec_80c_home_loan_principal NUMERIC
(
  15,
  2
),
  sec_80c_tuition_fees NUMERIC
(
  15,
  2
),
  sec_80c_sukanya_samriddhi NUMERIC
(
  15,
  2
),
  sec_80c_nps_employee NUMERIC
(
  15,
  2
),
  sec_80c_total NUMERIC
(
  15,
  2
),
  sec_80ccd_1b_nps_additional NUMERIC
(
  15,
  2
),
  sec_80d_self_family NUMERIC
(
  15,
  2
),
  sec_80d_parents NUMERIC
(
  15,
  2
),
  sec_80d_preventive_health NUMERIC
(
  15,
  2
),
  sec_80d_total NUMERIC
(
  15,
  2
),
  sec_80e_education_loan NUMERIC
(
  15,
  2
),
  sec_80g_donations NUMERIC
(
  15,
  2
),
  sec_80gg_rent_paid NUMERIC
(
  15,
  2
),
  sec_24_home_loan_interest NUMERIC
(
  15,
  2
),
  hra_metro_city BOOLEAN DEFAULT FALSE,
  hra_rent_paid NUMERIC
(
  15,
  2
),
...
(
  ...
  other_income_interest NUMERIC
(
  15,
  2
),
  other_income_rental NUMERIC
(
  15,
  2
),
  other_income_capital_gains NUMERIC
(
  15,
  2
),
...
(
  ...
  previous_employer_name VARCHAR
(
  255
),
  previous_employer_pan VARCHAR
(
  10
),
  previous_employer_income NUMERIC
...
(
  ...
  investment_section VARCHAR
(
  50
),
  proof_description VARCHAR
(
  500
),
...
(
  ...
  old_regime_total_deductions NUMERIC
(
  15,
  2
),
  old_regime_taxable_income NUMERIC
(
  15,
  2
),
...
(
  ...
  new_regime_taxable_income NUMERIC
(
  15,
  2
),
...
(
  ...
  new_regime_cess NUMERIC
(
  15,
  2
),
  new_regime_rebate NUMERIC
(
  15,
  2
),
...
(
  ...
  max_users INTEGER,
  configuration TEXT,
  CONSTRAINT uc_tenant_applications_tenantId_application_id UNIQUE
(
  tenant_id,
  application_id
)
...
(
  ...
  CONSTRAINT uc_tickets_tenant_id_ticket_number UNIQUE
(
  tenant_id,
  ticket_number
)
...
(
  ...
  certificate_template_url VARCHAR
(
  500
)
  );
...
(
  ...
  last_accessed_at TIMESTAMPTZ,
  CONSTRAINT uc_user_app_access_user_id_application_id UNIQUE
(
  user_id,
  application_id
)
...
(
  ...
  CONSTRAINT uc_user_basic_notification_preferences_user_id_tenant_id UNIQUE
(
  user_id,
  tenant_id
)
...
(
  ...
  day_of_week JSONB,
  minimum_priority VARCHAR
(
  50
),
  CONSTRAINT uc_user_notification_preferences_userId_category UNIQUE
(
  user_id,
  category
)
...
(
  ...
  gender_diversity_ratio NUMERIC
(
  5,
  2
),
