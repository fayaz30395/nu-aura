...
BEGIN
  IF
NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'fk_employees_department') THEN
...
BEGIN
  IF
NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'fk_employees_manager') THEN
ALTER TABLE employees
...
BEGIN
  IF
NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'fk_employees_user') THEN
...
WHERE parent_department_id IS NOT NULL
  AND parent_department_id NOT IN (SELECT id FROM departments);
DO
$$
BEGIN
  IF
NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'fk_departments_parent') THEN
...
BEGIN
  IF
NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'fk_departments_manager') THEN
ALTER TABLE departments
...
BEGIN
  IF
NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'fk_leave_requests_employee') THEN
...
BEGIN
  IF
NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'fk_leave_requests_leave_type') THEN
ALTER TABLE leave_requests
...
BEGIN
  IF
NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'fk_leave_balances_employee') THEN
...
BEGIN
  IF
NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'fk_leave_balances_leave_type') THEN
ALTER TABLE leave_balances
...
BEGIN
  IF
NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'fk_attendance_records_employee') THEN
...
BEGIN
  IF
NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'fk_payslips_employee') THEN
...
DELETE
FROM payslips
WHERE payroll_run_id NOT IN (SELECT id FROM payroll_runs);
DO
$$
BEGIN
  IF
NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'fk_payslips_payroll_run') THEN
ALTER TABLE payslips
...
BEGIN
  IF
NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'fk_performance_reviews_employee') THEN
...
DELETE
FROM performance_reviews
WHERE review_cycle_id NOT IN (SELECT id FROM review_cycles);
DO
$$
BEGIN
  IF
NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'fk_performance_reviews_cycle') THEN
ALTER TABLE performance_reviews
...
BEGIN
  IF
NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'fk_user_roles_user') THEN
...
BEGIN
  IF
NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'fk_user_roles_role') THEN
ALTER TABLE user_roles
...
BEGIN
  IF
NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'fk_app_role_perms_role') THEN
