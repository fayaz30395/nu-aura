...
COMMENT
ON COLUMN project_employees.billing_rate IS 'Hourly billing rate charged to client';
COMMENT
ON COLUMN project_employees.cost_rate IS 'Internal cost rate for this allocation';
