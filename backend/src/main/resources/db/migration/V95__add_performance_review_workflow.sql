...
VALUES (v_perf_wf_id, v_tenant_id, 'Default Performance Review Workflow', 'PERFORMANCE_REVIEW', 'SEQUENTIAL', 1,
...
RAISE
NOTICE 'Created PERFORMANCE_REVIEW workflow definition with 2 approval steps';
ELSE
