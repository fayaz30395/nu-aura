...
(
  ...
  restricted_holiday_id UUID NOT NULL REFERENCES restricted_holidays
(
  id
),
  status VARCHAR
...
(
  ...
  updated_by UUID,
  version BIGINT DEFAULT 0,
  CONSTRAINT uk_rhs_employee_holiday UNIQUE
(
  tenant_id,
  employee_id,
  restricted_holiday_id
)
  );
...
(
  ...
  updated_by UUID,
  version BIGINT DEFAULT 0,
  CONSTRAINT uk_rhp_tenant_year UNIQUE
(
  tenant_id,
  year
)
