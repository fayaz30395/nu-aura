...
COMMENT
ON COLUMN lms_course_enrollments.completion_date  IS 'Calendar date the course was completed';
COMMENT
ON COLUMN lms_course_enrollments.certificate_url  IS 'URL to the issued certificate PDF/image (MinIO or external)';
