...
COMMENT
ON COLUMN employees.dotted_line_manager1_id IS 'Optional first dotted-line manager (matrix reporting, informational only)';
COMMENT
ON COLUMN employees.dotted_line_manager2_id IS 'Optional second dotted-line manager (matrix reporting, informational only)';
