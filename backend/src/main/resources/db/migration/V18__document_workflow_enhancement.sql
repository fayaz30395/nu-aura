...
(
  50
) NOT NULL DEFAULT 'PENDING', -- PENDING, IN_PROGRESS, APPROVED, REJECTED
...
(
  50
) NOT NULL DEFAULT 'PENDING', -- PENDING, APPROVED, REJECTED, DELEGATED
...
(
  workflow_id
) REFERENCES document_approval_workflows
(
  id
) ON DELETE CASCADE,
  FOREIGN KEY
...
(
  50
) NOT NULL, -- VIEW, EDIT, MANAGE, APPROVE
