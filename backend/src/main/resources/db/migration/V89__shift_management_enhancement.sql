...
ALTER TABLE shifts
  ADD COLUMN IF NOT EXISTS flexible_window_minutes INTEGER DEFAULT 0;
ALTER TABLE shifts
  ADD COLUMN IF NOT EXISTS min_gap_between_shifts_hours INTEGER DEFAULT 11;
...
(
  ...
  tenant_id UUID NOT NULL,
  roster_id UUID NOT NULL REFERENCES rosters
(
  id
) ON DELETE CASCADE,
...
SELECT gen_random_uuid(),
       ...
       'GEN',
       'General (9-6)',
       'Standard general shift 9 AM to 6 PM',
       '09:00:00',
       '18:00:00',
       15,
       15,
...
SELECT gen_random_uuid(),
       ...
       'FLX',
       'Flexible (core 10-4)',
       'Flexible shift with core hours 10 AM to 4 PM',
       '10:00:00',
       '16:00:00',
       30,
       30,
