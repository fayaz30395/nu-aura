...
VALUES ('48000000-0e02-0000-0000-000000000014',
...
INSERT INTO employees (id, tenant_id, employee_code, user_id, first_name, last_name, designation, level, job_role,
                       ...
                       version, is_deleted)
VALUES ('48000000-e001-0000-0000-000000000014',
        '660e8400-e29b-41d4-a716-446655440001',
        'EMP-0015',
...
VALUES ('48000000-0e02-0000-0000-000000000014', '48000000-0e01-0000-0000-000000000001') ON CONFLICT DO NOTHING;
...
INSERT INTO projects (id, tenant_id, project_code, name, description, start_date, expected_end_date, status, priority,
                      project_manager_id, client_name, budget, currency, created_at, updated_at, created_by, updated_by,
                      version, is_deleted)
VALUES ('48000000-0e03-0000-0000-000000000001',
        '660e8400-e29b-41d4-a716-446655440001',
        'PROJ-001',
        ...
        0, false) ON CONFLICT (id) DO NOTHING;

-- Project 2: Mobile App Development
INSERT INTO projects (id, tenant_id, project_code, name, description, start_date, expected_end_date, status, priority,
                      project_manager_id, client_name, budget, currency, created_at, updated_at, created_by, updated_by,
                      version, is_deleted)
VALUES ('48000000-0e03-0000-0000-000000000002',
        '660e8400-e29b-41d4-a716-446655440001',
        'PROJ-002',
...
INSERT INTO projects (id, tenant_id, project_code, name, description, start_date, expected_end_date, status, priority,
                      project_manager_id, client_name, budget, currency, created_at, updated_at, created_by, updated_by,
                      version, is_deleted)
VALUES ('48000000-0e03-0000-0000-000000000003',
        '660e8400-e29b-41d4-a716-446655440001',
        'PROJ-003',
...
INSERT INTO projects (id, tenant_id, project_code, name, description, start_date, expected_end_date, status, priority,
                      project_manager_id, client_name, budget, currency, created_at, updated_at, created_by, updated_by,
                      version, is_deleted)
VALUES ('48000000-0e03-0000-0000-000000000004',
        '660e8400-e29b-41d4-a716-446655440001',
        'PROJ-004',
...
INSERT INTO projects (id, tenant_id, project_code, name, description, start_date, expected_end_date, status, priority,
                      project_manager_id, client_name, budget, currency, created_at, updated_at, created_by, updated_by,
                      version, is_deleted)
VALUES ('48000000-0e03-0000-0000-000000000005',
        '660e8400-e29b-41d4-a716-446655440001',
        'PROJ-005',
...
INSERT INTO project_members (id, tenant_id, project_id, employee_id, role, allocation_percentage, start_date, is_active,
                             can_approve_time, notes, created_at, updated_at)
VALUES ('48000000-0e04-0000-0001-000000000001',
        '660e8400-e29b-41d4-a716-446655440001',
...
INSERT INTO project_members (id, tenant_id, project_id, employee_id, role, allocation_percentage, start_date, is_active,
                             can_approve_time, notes, created_at, updated_at)
VALUES ('48000000-0e04-0000-0001-000000000002',
        '660e8400-e29b-41d4-a716-446655440001',
        '48000000-0e03-0000-0000-000000000001',
...
INSERT INTO project_members (id, tenant_id, project_id, employee_id, role, allocation_percentage, start_date, is_active,
                             can_approve_time, notes, created_at, updated_at)
VALUES ('48000000-0e04-0000-0001-000000000003',
        '660e8400-e29b-41d4-a716-446655440001',
        '48000000-0e03-0000-0000-000000000001',
...
INSERT INTO project_members (id, tenant_id, project_id, employee_id, role, allocation_percentage, start_date, is_active,
                             can_approve_time, notes, created_at, updated_at)
VALUES ('48000000-0e04-0000-0001-000000000004',
        '660e8400-e29b-41d4-a716-446655440001',
        '48000000-0e03-0000-0000-000000000001',
...
INSERT INTO project_members (id, tenant_id, project_id, employee_id, role, allocation_percentage, start_date, is_active,
                             can_approve_time, notes, created_at, updated_at)
VALUES ('48000000-0e04-0000-0001-000000000005',
        '660e8400-e29b-41d4-a716-446655440001',
        '48000000-0e03-0000-0000-000000000001',
...
INSERT INTO project_members (id, tenant_id, project_id, employee_id, role, allocation_percentage, start_date, is_active,
                             can_approve_time, notes, created_at, updated_at)
VALUES ('48000000-0e04-0000-0002-000000000001',
        '660e8400-e29b-41d4-a716-446655440001',
...
INSERT INTO project_members (id, tenant_id, project_id, employee_id, role, allocation_percentage, start_date, is_active,
                             can_approve_time, notes, created_at, updated_at)
VALUES ('48000000-0e04-0000-0002-000000000002',
        '660e8400-e29b-41d4-a716-446655440001',
        '48000000-0e03-0000-0000-000000000002',
...
INSERT INTO project_members (id, tenant_id, project_id, employee_id, role, allocation_percentage, start_date, is_active,
                             can_approve_time, notes, created_at, updated_at)
VALUES ('48000000-0e04-0000-0002-000000000003',
        '660e8400-e29b-41d4-a716-446655440001',
        '48000000-0e03-0000-0000-000000000002',
        '48000000-e001-0000-0000-000000000006',
        'DEVELOPER', 30.00,
...
INSERT INTO project_members (id, tenant_id, project_id, employee_id, role, allocation_percentage, start_date, is_active,
                             can_approve_time, notes, created_at, updated_at)
VALUES ('48000000-0e04-0000-0003-000000000001',
        '660e8400-e29b-41d4-a716-446655440001',
...
INSERT INTO project_members (id, tenant_id, project_id, employee_id, role, allocation_percentage, start_date, is_active,
                             can_approve_time, notes, created_at, updated_at)
VALUES ('48000000-0e04-0000-0003-000000000002',
        '660e8400-e29b-41d4-a716-446655440001',
        '48000000-0e03-0000-0000-000000000003',
        '48000000-e001-0000-0000-000000000002',
        'DEVELOPER', 40.00,
...
INSERT INTO project_members (id, tenant_id, project_id, employee_id, role, allocation_percentage, start_date, is_active,
                             can_approve_time, notes, created_at, updated_at)
VALUES ('48000000-0e04-0000-0003-000000000003',
        '660e8400-e29b-41d4-a716-446655440001',
        '48000000-0e03-0000-0000-000000000003',
...
INSERT INTO project_members (id, tenant_id, project_id, employee_id, role, allocation_percentage, start_date, is_active,
                             can_approve_time, notes, created_at, updated_at)
VALUES ('48000000-0e04-0000-0004-000000000001',
        '660e8400-e29b-41d4-a716-446655440001',
...
INSERT INTO project_members (id, tenant_id, project_id, employee_id, role, allocation_percentage, start_date, is_active,
                             can_approve_time, notes, created_at, updated_at)
VALUES ('48000000-0e04-0000-0004-000000000002',
        '660e8400-e29b-41d4-a716-446655440001',
        '48000000-0e03-0000-0000-000000000004',
        '48000000-e001-0000-0000-000000000004',
        'DEVELOPER', 20.00,
...
INSERT INTO project_members (id, tenant_id, project_id, employee_id, role, allocation_percentage, start_date, is_active,
                             can_approve_time, notes, created_at, updated_at)
VALUES ('48000000-0e04-0000-0005-000000000001',
        '660e8400-e29b-41d4-a716-446655440001',
