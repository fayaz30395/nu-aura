...
class StatutoryIntegrationTest extends AbstractPostgresIntegrationTest {
    ...
    void ucStat2_submitTDSDeclaration_returns200() throws Exception {
        ...
        declaration.setTaxRegime(com.nulogic.domain.statutory.TDSSlab.TaxRegime.NEW_REGIME);
