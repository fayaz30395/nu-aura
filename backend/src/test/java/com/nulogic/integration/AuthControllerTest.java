...
class AuthControllerTest {
    ...
    void ucAuth001_wrongPassword_returns401() throws Exception {
        ...
        when(authService.login(any(LoginRequest.class)))
                .thenThrow(new com.nulogic.common.exception.AuthenticationException("Invalid credentials"));
    ...
    void ucAuth002_invalidGoogleToken_returns400() throws Exception {
        ...
        when(authService.googleLogin(any(GoogleLoginRequest.class)))
                .thenThrow(new com.nulogic.common.exception.ValidationException("Invalid Google token"));
    ...
    void ucAuth003_mfaVerify_wrongCode_returns401() throws Exception {
        ...
        doThrow(new com.nulogic.common.exception.AuthenticationException("Invalid MFA code"))
    ...
    void ucAuth005_tokenRefresh_invalid_throwsException() throws Exception {
        when(authService.refresh(eq("expired-token")))
                .thenThrow(new com.nulogic.common.exception.AuthenticationException("Refresh token expired or invalid"));
    ...
    void ucAuth006_resetPassword_invalidToken_returns400() throws Exception {
        ...
        doThrow(new com.nulogic.common.exception.ValidationException("Invalid or expired reset token"))
