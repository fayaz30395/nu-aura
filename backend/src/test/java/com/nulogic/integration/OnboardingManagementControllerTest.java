...
import com.nulogic.api.onboarding.dto.OnboardingChecklistTemplateRequest;
...
class OnboardingManagementControllerTest extends AbstractPostgresIntegrationTest {
    ...
    void ucHire006_createOnboardingProcess_returns201() throws Exception {
        ...
        mockMvc.perform(post(BASE + "/processes")
                ...
                .andExpect(result ->
                        org.assertj.core.api.Assertions.assertThat(
                                result.getResponse().getStatus()).isIn(201, 400, 409));
    }
    ...
    void ucHire007_exitProcessCreation_returns201() throws Exception {
        ...
        mockMvc.perform(post("/api/v1/exit/processes")
                ...
                .andExpect(result ->
                        org.assertj.core.api.Assertions.assertThat(
                                result.getResponse().getStatus()).isIn(201, 400, 404, 409));
    }
