...
class PayrollControllerTest extends AbstractPostgresIntegrationTest {
    ...
    void ucPay001_duplicateSalaryStructure_returns409() throws Exception {
        ...
        when(salaryStructureService.createSalaryStructure(any(SalaryStructure.class)))
                .thenThrow(new com.nulogic.common.exception.DuplicateResourceException(
    ...
    void ucPay001_missingSalaryField_returns400() throws Exception {
        ...
        when(salaryStructureService.createSalaryStructure(any(SalaryStructure.class)))
                .thenThrow(new com.nulogic.common.exception.ValidationException("Basic salary is required"));
    ...
    void ucPay004_generatePayslipPdf_notFound_returns404() throws Exception {
        ...
        when(payslipService.getPayslipById(eq(missingId)))
                .thenThrow(new com.nulogic.common.exception.ResourceNotFoundException("Payslip", "id", missingId.toString()));
