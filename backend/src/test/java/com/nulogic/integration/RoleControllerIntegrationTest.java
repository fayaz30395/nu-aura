...
import com.nulogic.api.user.dto.AssignPermissionsRequest;
import com.nulogic.api.user.dto.CreateRoleRequest;
...
class RoleControllerIntegrationTest extends AbstractPostgresIntegrationTest {
    ...
    private void seedTestPermissions() {
        com.nulogic.domain.user.Permission readPerm = new com.nulogic.domain.user.Permission();
        ...
        com.nulogic.domain.user.Permission updatePerm = new com.nulogic.domain.user.Permission();
        ...
        com.nulogic.domain.user.Permission createPerm = new com.nulogic.domain.user.Permission();
        ...
        com.nulogic.domain.user.Permission deletePerm = new com.nulogic.domain.user.Permission();
