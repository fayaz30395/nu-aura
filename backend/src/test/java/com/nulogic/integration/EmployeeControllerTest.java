...
@Transactional
class EmployeeControllerTest extends AbstractPostgresIntegrationTest {
    ...
    void ucEmp002_hrUpdatesEmployee_returns200() throws Exception {
        ...
        com.nulogic.api.employee.dto.AdminEmployeeUpdateRequest adminReq =
                new com.nulogic.api.employee.dto.AdminEmployeeUpdateRequest();
