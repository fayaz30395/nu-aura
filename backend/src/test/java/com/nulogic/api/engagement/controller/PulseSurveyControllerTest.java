package com.nulogic.api.engagement.controller;
...
import com.nulogic.application.engagement.service.PulseSurveyService;
...
import com.nulogic.domain.engagement.PulseSurvey.SurveyType;
...
class PulseSurveyControllerTest {
    ...
    class SurveyResponseTests {
        ...
        void shouldStartSurveyForEmployee() throws Exception {
            ...
            com.nulogic.domain.engagement.PulseSurveyResponse surveyResponse =
                    new com.nulogic.domain.engagement.PulseSurveyResponse();
        ...
        void shouldSubmitSurveyResponse() throws Exception {
            ...
            com.nulogic.domain.engagement.PulseSurveyResponse submittedResponse =
                    new com.nulogic.domain.engagement.PulseSurveyResponse();
            submittedResponse.setId(responseId);
            submittedResponse.setSubmittedAt(LocalDateTime.now());
            submittedResponse.setStatus(com.nulogic.domain.engagement.PulseSurveyResponse.ResponseStatus.SUBMITTED);
