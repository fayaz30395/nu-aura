...
import com.nulogic.application.knowledge.service.ContentEngagementService;
import com.nulogic.common.security.JwtAuthenticationFilter;
import com.nulogic.common.security.TenantFilter;
import com.nulogic.domain.knowledge.KnowledgeView;
...
class ContentEngagementControllerTest {
    ...
    class FavoriteTests {
        ...
        void shouldGetFavorites() throws Exception {
            Page<com.nulogic.domain.knowledge.FluenceFavorite> emptyPage =
