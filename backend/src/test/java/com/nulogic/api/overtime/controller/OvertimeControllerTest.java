package com.nulogic.api.overtime.controller;
...
import com.nulogic.application.overtime.service.OvertimeManagementService;
    ...
    class ApprovalTests {
        ...
        void approveOvertime_returns200() throws Exception {
            ...
            when(overtimeManagementService.approveOrRejectOvertime(
                    eq(RECORD_ID), any(), any(OvertimeApprovalRequest.class)))
