    ...
    class ControllerLayerTests {
        ...
        void controllersShouldResideInApiPackage() {
            ArchRule rule = classes()
                    ...
                    .and().doNotHaveFullyQualifiedName("com.nulogic.common.security.ApiKeyController")
                    .and().doNotHaveFullyQualifiedName("com.nulogic.domain.notification.WebSocketNotificationController")
    ...
    class ServiceLayerTests {
        ...
        void servicesShouldResideInApplicationPackage() {
            ArchRule rule = classes()
                    ...
                    .and().doNotHaveFullyQualifiedName("com.nulogic.api.monitoring.service.MonitoringService")
                    ...
                    .and().doNotHaveFullyQualifiedName("com.nulogic.infrastructure.search.service.FluenceIndexingService")
                    .and().doNotHaveFullyQualifiedName("com.nulogic.infrastructure.search.service.FluenceSearchService")
    ...
    class RepositoryLayerTests {
        ...
        void repositoriesShouldResideInInfrastructurePackage() {
            ArchRule rule = classes()
                    ...
                    .and().doNotHaveFullyQualifiedName("com.nulogic.domain.payment.PaymentBatchRepository")
                    .and().doNotHaveFullyQualifiedName("com.nulogic.domain.payment.PaymentConfigRepository")
                    .and().doNotHaveFullyQualifiedName("com.nulogic.domain.payment.PaymentRefundRepository")
                    .and().doNotHaveFullyQualifiedName("com.nulogic.domain.payment.PaymentTransactionRepository")
                    .and().doNotHaveFullyQualifiedName("com.nulogic.domain.payment.PaymentWebhookRepository")
