    ...
    <div className="g-12 grid">
      <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
        <Card>
          ...
          <Button variant="primary" size="sm" icon="calendar-plus" className="btn--block" style={{ marginTop: 18 }} onClick={() => window.nuToast('Time-off request', { msg: 'Opening the request form…', type:'info' })}>Request time off</Button>
        </Card>
        <Card>
