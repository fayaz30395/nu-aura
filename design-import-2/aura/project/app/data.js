...
(function () {
  ...
  const roles = [
    { name:'Super Admin', users:3, perms:512, scope:'All products', tone:'err', desc:'Unrestricted access across every product, billing and security.' },
    { name:'HR Administrator', users:12, perms:418, scope:'NU-HRMS, NU-Hire', tone:'primary', desc:'Full people operations: employees, payroll oversight, hiring.' },
    { name:'Payroll Manager', users:6, perms:142, scope:'Payroll, Benefits', tone:'primary', desc:'Runs payroll cycles and manages benefit programs.' },
    { name:'Recruiter', users:18, perms:96, scope:'NU-Hire', tone:'neutral', desc:'Owns the hiring pipeline, candidates and offers.' },
    { name:'Manager', users:142, perms:64, scope:'Team scope', tone:'neutral', desc:'Approvals, attendance and reviews for direct reports.' },
    { name:'Finance', users:9, perms:88, scope:'Payroll (read)', tone:'neutral', desc:'Read access to payroll and cost reporting.' },
    { name:'Employee', users:1058, perms:24, scope:'Self-service', tone:'neutral', desc:'Personal profile, payslips, time-off requests.' },
    { name:'Auditor', users:4, perms:36, scope:'Read-only', tone:'warn', desc:'Read-only visibility for compliance review.' },
    { name:'Contractor', users:31, perms:12, scope:'Limited', tone:'warn', desc:'Restricted self-service for external staff.' },
  ];

  // RBAC permission matrix — levels: 0 None · 1 View · 2 Edit · 3 Manage
  const rbacModules = [
    { key:'Employees', icon:'users' }, { key:'Attendance', icon:'fingerprint' }, { key:'Leave', icon:'palmtree' },
    { key:'Payroll', icon:'banknote' }, { key:'Benefits', icon:'heart-pulse' }, { key:'Assets', icon:'package' },
    { key:'Reports', icon:'bar-chart-3' }, { key:'Recruitment', icon:'briefcase' }, { key:'Settings', icon:'settings' },
  ];
  const accessLevels = ['None','View','Edit','Manage'];
  const rolePerms = {
    'Super Admin':      [3,3,3,3,3,3,3,3,3],
    'HR Administrator': [3,3,3,2,3,3,3,2,2],
    'Payroll Manager':  [1,1,1,3,3,0,2,0,0],
    'Recruiter':        [1,0,0,0,0,0,1,3,0],
    'Manager':          [2,2,2,0,1,1,1,1,0],
    'Finance':          [1,0,0,1,1,0,2,0,0],
    'Employee':         [1,1,2,1,2,1,0,0,0],
    'Auditor':          [1,1,1,1,1,1,1,1,1],
    'Contractor':       [1,1,1,0,0,0,0,0,0],
  };
  ...
  window.NU = {
    ...
    rbacModules, accessLevels, rolePerms,
