    ...
    <div className="page">
      <div className="phead">
        ...
        <div className="pactions">
          ...
          <Button variant="primary" icon="play" onClick={() => window.nuToast('Payroll run started', { msg: 'April 2026 cycle is now calculating.', type:'info' })}>Run Payroll</Button>
        </div>
      </div>
      ...
      <Card pad={false} style={{ marginBottom: 16, overflow: 'hidden' }}>
        <div style={{ padding: '22px 24px', background: 'linear-gradient(135deg, color-mix(in srgb, var(--accent) 8%, var(--surface)), var(--surface) 60%)' }}>
          <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: 20, flexWrap: 'wrap' }}>
            ...
            <Button variant="primary" size="lg" icon="shield-check" onClick={() => window.nuToast('Payroll approved', { msg: 'April 2026 cycle sent for disbursement.', type:'ok' })}>Review &amp; approve</Button>
          </div>
