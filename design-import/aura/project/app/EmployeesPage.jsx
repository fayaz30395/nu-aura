        ...
        <div className="sheet__scroll">
          ...
          <div style={{ padding: '28px 28px 20px', background: `linear-gradient(160deg, color-mix(in srgb, ${bg} 16%, var(--surface)), var(--surface) 70%)`, borderBottom: '1px solid var(--border)' }}>
            ...
            <div style={{ display: 'flex', gap: 8, marginTop: 18 }}>
              <Button variant="primary" size="sm" icon="message-square">Message</Button>
    ...
    <div className="page">
      <div className="phead">
        ...
        <div className="pactions">
          ...
          <Button variant="primary" icon="user-plus">Add Employee</Button>
        </div>
      </div>
      ...
      <Card pad={false}>
        {sel.size > 0 ? (
          <div className="bulkbar">
            ...
            <button className="btn btn--ghostdark btn--sm" ><Icon name="mail" size={14} />Message</button>
            <button className="btn btn--ghostdark btn--sm" ><Icon name="folder-input" size={14} />Move team</button>
            <button className="btn btn--ghostdark btn--sm" ><Icon name="download" size={14} />Export</button>
            <button className="btn btn--ghostdark btn--sm" ><Icon name="user-x" size={14} />Offboard</button>
