...
export default function EmployeeDashboardPage() {
  ...
  const getEventColor = (type: string) => {
    switch (type) {
      ...
      default:
        return 'bg-surface-50 dark:bg-surface-800 text-surface-600 dark:text-surface-400';
    }
  };
            ...
            <CardContent className="p-5">
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <p className="text-xs text-surface-400 mt-1">This year</p>
                </div>
            ...
            <CardContent className="p-5">
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <p className="text-xs text-surface-400 mt-1">Remaining</p>
                </div>
            ...
            <CardContent className="p-5">
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <p className="text-xs text-surface-400 mt-1">Per day</p>
                </div>
