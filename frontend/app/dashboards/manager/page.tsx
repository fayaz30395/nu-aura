...
const statusBadgeStyles: Record<string, string> = {
  IN_PROGRESS: 'bg-sky-500/10 text-sky-700 dark:text-sky-400 border-sky-500/20',
        ...
        <motion.div variants={itemVariants} className="flex flex-col md:flex-row md:items-center justify-between gap-3">
          <div>
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-[10px] font-bold uppercase tracking-wider text-sky-700 dark:text-sky-400">Live Insights</span>
            </div>
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div className="flex flex-col">
                      ...
                      <span className="text-xs font-bold text-sky-700">{teamOverview.directReports} Direct</span>
                    </div>
                  </div>
                </div>
              </CardContent>
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div className="flex flex-col">
                      ...
                      <span className="text-xs font-bold text-emerald-600 dark:text-emerald-400">{teamAttendance.workFromHomeToday} WFH</span>
                    </div>
                  </div>
                </div>
              </CardContent>
              ...
              <CardContent className="p-3">
                <div className="flex flex-col gap-1">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div className="h-6 w-0.5 rounded-full bg-amber-500" />
                    <div className="flex flex-col">
                      <span className="text-[10px] font-bold text-[var(--text-muted)]">Confirmed</span>
                      <span className="text-xs font-bold text-amber-600 dark:text-amber-400">{teamLeave.pendingApprovals} Pending</span>
                    </div>
                  </div>
                </div>
              </CardContent>
              ...
              <CardContent className="p-3">
                <div className="flex flex-col gap-1">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div className="h-6 w-0.5 rounded-full bg-indigo-500" />
                    <div className="flex flex-col">
                      <span className="text-[10px] font-bold text-[var(--text-muted)]">Total</span>
                      <span className="text-xs font-bold text-indigo-600 dark:text-indigo-400">{actionItems.overdueApprovals + actionItems.overdueReviews} Alert</span>
                    </div>
                  </div>
                </div>
              </CardContent>
                ...
                <div className="space-y-3">
                  <div className="grid grid-cols-2 gap-2">
                    ...
                    <div className="p-2.5 bg-emerald-500/5 rounded-xl border border-emerald-500/10">
                      ...
                      <div className="flex items-center gap-2">
                        <span className="text-xl font-black text-emerald-600 dark:text-emerald-400 font-mono tracking-tighter">
                          {teamAttendance.monthlyAttendanceRate?.toFixed(1)}%
                        </span>
                        {teamAttendance.monthlyAttendanceChange !== 0 && (
                          <div className={`p-1 rounded-full ${teamAttendance.monthlyAttendanceChange > 0 ? 'bg-green-500' : 'bg-red-500'}`}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 items-center">
                  <div className="space-y-3">
                    ...
                    <div>
                      ...
                      <div className="flex justify-between mt-1 font-bold text-xs text-amber-600">
            ...
            <Card className="border-0 shadow-2xl bg-[var(--bg-card)] overflow-hidden">
              <CardHeader className="border-b border-[var(--border-main)]/50 dark:border-[var(--border-main)]/50 py-2.5 px-4">
                <CardTitle className="flex items-center justify-between">
                  ...
                  <Badge className="bg-sky-500/10 text-sky-700 dark:text-sky-400 border-sky-500/20 text-[10px]">
                    ...
                    >
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2.5">
                          <div className="h-7 w-7 rounded-lg bg-gradient-to-br from-sky-500 to-indigo-600 text-white flex items-center justify-center font-black text-xs shadow-md">
                            {leave.employeeName?.charAt(0)}
                          </div>
                          <div>
                            <div className="flex items-center gap-2">
                              <span className="font-bold text-xs text-[var(--text-primary)] group-hover:text-sky-500 transition-colors">{leave.employeeName}</span>
                              {leave.urgency === 'HIGH' && (
              ...
              <CardContent className="p-3">
                <div className="space-y-1.5">
                  ...
                  {(actionItems.overdueApprovals > 0 || actionItems.overdueReviews > 0) && (
                    <div className="mt-2 p-2 rounded-xl bg-red-500/10 border border-red-500/20 text-red-600 dark:text-red-400 flex items-center gap-2">
              ...
              <CardTitle className="flex items-center justify-between">
                ...
                {teamProjectsData?.summary && (
                  <div className="flex items-center gap-2 text-[10px] font-bold text-[var(--text-muted)]">
                    ...
                    <span className="text-emerald-600 dark:text-emerald-400">{teamProjectsData.summary.allocatedCount} Allocated</span>
                    <span className="h-1 w-1 rounded-full bg-[var(--text-muted)]" />
                    <span className="text-amber-600 dark:text-amber-400">{teamProjectsData.summary.unallocatedCount} Unallocated</span>
                    <span className="h-1 w-1 rounded-full bg-[var(--text-muted)]" />
            ...
            <CardContent className="p-3">
              ...
              {!teamProjectsLoading && teamProjectsError && (
                <div className="p-8 text-center">
                  <div className="h-14 w-14 rounded-full bg-sky-500/10 flex items-center justify-center mx-auto mb-3">
                    <Briefcase className="h-7 w-7 text-sky-500" />
                  </div>
                  ...
                  {teamProjectsData.teamMembers.map((member: TeamMemberWithProjects) => (
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between mb-2">
                        <div className="flex items-center gap-3">
                          <div className="h-8 w-8 rounded-lg bg-gradient-to-br from-sky-500 to-indigo-600 text-white flex items-center justify-center font-black text-xs shadow-md">
                            {member.employeeName?.charAt(0)}
                          </div>
                          <div>
                            <button
                              onClick={() => router.push(`/employees/${member.employeeId}`)}
                              className="font-extrabold text-[var(--text-primary)] hover:text-sky-600 dark:hover:text-sky-400 transition-colors text-left"
                            >
                              {member.employeeName}
                            </button>
                        ...
                        <div className="flex items-center gap-3">
                          {member.isOverAllocated && (
                            <div className="flex items-center gap-1 text-xs font-black text-red-600 dark:text-red-400 bg-red-500/10 px-2.5 py-1 rounded-full">
                            ...
                            >
                              <div className="flex items-center gap-3">
                                ...
                                <button
                                  ...
                                  className="font-bold text-sm text-[var(--text-primary)] hover:text-sky-600 dark:hover:text-sky-400 transition-colors flex items-center gap-1.5"
                                >
                                  {project.projectName}
            ...
            >
              <Card className="border-0 shadow-2xl bg-danger-50 dark:bg-danger-950 overflow-hidden">
                <CardContent className="p-3">
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center gap-2">
                      <div className="h-7 w-7 rounded-lg bg-red-500 text-white flex items-center justify-center shadow-md">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                    {teamAlerts.slice(0, 3).map((alert) => (
                      <div key={alert.id} className="p-3 rounded-xl bg-white/40 dark:bg-black/20 border border-red-500/10">
                        <div className="flex items-center gap-2 mb-1">
                          <Badge className="bg-red-500 text-white font-black px-1.5 py-0 text-[10px]">CRITICAL</Badge>
                        ...
                        <div className="mt-2 pt-2 border-t border-[var(--border-main)]/50 dark:border-[var(--border-main)]/50 flex items-center justify-between">
                          <span className="text-[10px] font-black uppercase text-sky-500">Action: {alert.actionRequired}</span>
