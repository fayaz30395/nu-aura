  ...
  return (
    <div className="p-6 space-y-6 animate-pulse">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {[...Array(4)].map((_, i) => (
          <div key={i} className="bg-white border border-[var(--border-main)] rounded-xl p-5 space-y-3">
            <div className="flex items-center justify-between">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 bg-white border border-[var(--border-main)] rounded-xl p-5 space-y-4">
          <div className="flex items-center justify-between">
        ...
        <div className="space-y-4">
          {[...Array(3)].map((_, i) => (
            <div key={i} className="bg-white border border-[var(--border-main)] rounded-xl p-4 space-y-3">
              <div className="h-4 w-32 bg-gray-200 rounded" />
              <div className="h-6 w-16 bg-gray-300 rounded" />
              <div className="h-2 w-full bg-[var(--bg-surface)] rounded-full">
                <div className="h-2 bg-gray-200 rounded-full" style={{ width: `${40 + i * 20}%` }} />
              </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {[...Array(2)].map((_, i) => (
          <div key={i} className="bg-white border border-[var(--border-main)] rounded-xl p-5 space-y-4">
