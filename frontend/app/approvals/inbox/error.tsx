...
import { RefreshCw, Home, CheckSquare } from 'lucide-react';
...
export default function ApprovalsInboxError({ error, reset }: ErrorProps) {
  useEffect(() => {
    handleError(error, { source: 'approvals-inbox-error-boundary', digest: error.digest });
  }, [error]);
