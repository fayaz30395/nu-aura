            ...
            <div key={payslip.id} className="bg-[var(--bg-card)] rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
              ...
              <div className="space-y-4 mb-4">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span className="text-green-600 font-medium">{formatCurrency(payslip.allowances)}</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-[var(--text-secondary)]">Deductions</span>
                  <span className="text-red-600 font-medium">{formatCurrency(payslip.deductions)}</span>
                </div>
