...
import {Home, RefreshCw, CreditCard} from 'lucide-react';
...
export default function PayrollRunError({error, reset}: ErrorProps) {
  useEffect(() => {
    handleError(error, {source: 'payroll-runs-[id]-error-boundary', digest: error.digest});
  }, [error]);
        ...
        <Card className="page-shell-card float-subtle">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex flex-col gap-2">
              ...
              <Button variant="outline" onClick={() => (window.location.href = '/payroll/runs')} className="w-full">
                <CreditCard className="mr-2 h-4 w-4"/>Back to Payroll Runs
              </Button>
