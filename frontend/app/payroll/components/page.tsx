...
export default function PayrollComponentsPage() {
  return (
    <AppLayout activeMenuItem="payroll-components">
      <div className="flex flex-col items-center justify-center min-h-[60vh] text-center px-4">
        <div className="p-5 rounded-2xl bg-gradient-to-br from-primary-100 to-primary-50 dark:from-primary-900/20 dark:to-primary-800/10 mb-6">
          <Puzzle className="h-12 w-12 text-primary-600 dark:text-primary-400" />
        </div>
        <h1 className="text-3xl font-bold text-[var(--text-primary)] skeuo-emboss mb-3">
          Payroll Components
        </h1>
        <p className="text-[var(--text-secondary)] max-w-md mb-8">
          Configure earnings, deductions, and tax components for your payroll structure.
