                ...
                <Stack gap="md">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      {...register('employeeId')}
                      className="w-full rounded-lg border border-[var(--border-main)] bg-[var(--bg-input)] px-3 py-2 text-sm text-[var(--text-primary)] placeholder:text-[var(--text-muted)] focus:outline-none focus:ring-2 focus:ring-sky-700 focus:ring-offset-2 transition-colors"
                    />
                    {errors.employeeId && (
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full rounded-lg border border-[var(--border-main)] bg-[var(--bg-input)] px-3 py-2 text-sm text-[var(--text-primary)] focus:outline-none focus:ring-2 focus:ring-sky-700 focus:ring-offset-2 transition-colors"
                    />
                  ...
                  <Group justify="flex-end" gap="sm" pt="sm">
                    ...
                    <button
                      type="submit"
                      disabled={isPending}
                      className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-white bg-accent-700 hover:bg-accent-800 disabled:opacity-60 disabled:cursor-not-allowed rounded-lg transition-colors"
                    >
                      {isPending ? (
