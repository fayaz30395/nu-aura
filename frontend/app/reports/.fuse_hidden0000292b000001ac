  ...
  return (
    <div className="p-6 space-y-6 animate-pulse">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {[...Array(4)].map((_, i) => (
          <div key={i} className="bg-white border border-[var(--border-main)] rounded-lg p-4 space-y-2">
      ...
      {/* Main chart */}
      <div className="bg-white border border-[var(--border-main)] rounded-lg p-5 space-y-4">
        <div className="flex items-center justify-between">
