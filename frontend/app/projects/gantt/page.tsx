          ...
          <CardContent className="p-0 overflow-x-auto">
            <div className="min-w-[1200px]">
              ...
              <div className="flex border-b border-[var(--border-main)]">
                <div
                  className="w-64 flex-shrink-0 p-4 bg-[var(--bg-secondary)] font-semibold border-r border-[var(--border-main)]">
                  Task Name
                </div>
              ...
              {ganttTasks.length === 0 && (
                <div className="flex flex-col items-center justify-center py-24 text-center">
                  ...
                  <p className="text-body-muted max-w-md">
                    The Gantt chart view is under development. Project timelines will be visualized here once task
