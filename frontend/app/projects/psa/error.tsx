...
export default function PsaProjectsError({error, reset}: ErrorProps) {
  useEffect(() => {
    handleError(error, {source: 'psa-projects-error-boundary', digest: error.digest});
  }, [error]);
        ...
        <Card className="page-shell-card float-subtle">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex flex-col gap-2">
              ...
              <Button variant="outline" onClick={() => (window.location.href = '/projects')} className="w-full">
