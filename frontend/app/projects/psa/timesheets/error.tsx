...
export default function PsaTimesheetsError({error, reset}: ErrorProps) {
  useEffect(() => {
    handleError(error, {source: 'psa-timesheets-error-boundary', digest: error.digest});
  }, [error]);
      ...
      >
        <Card className="page-shell-card float-subtle">
          <CardHeader className="text-center">
            ...
            <CardTitle className="text-xl font-semibold text-surface-900 dark:text-surface-50">App Error</CardTitle>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex flex-col gap-2">
              ...
              <Button variant="outline" onClick={() => (window.location.href = '/projects/psa')} className="w-full">
                <Grid className="mr-2 h-4 w-4"/>Back
              </Button>
