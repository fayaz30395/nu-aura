...
import { AlertTriangle, RefreshCw, Home, FileCheck } from 'lucide-react';
...
export default function OfferPortalError({ error, reset }: ErrorProps) {
  useEffect(() => {
    handleError(error, { source: 'offer-portal-error-boundary', digest: error.digest });
  }, [error]);
