...
export default function OrgHealthError({error, reset}: ErrorProps) {
  useEffect(() => {
    handleError(error, {source: 'org-health-error-boundary', digest: error.digest});
  }, [error]);
        ...
        <Card className="w-full max-w-md bg-[var(--bg-card)]">
          <CardHeader className="text-center">
            <div
              ...
              <TrendingUp className="h-6 w-6 text-danger-600 dark:text-danger-400"/>
            </div>
