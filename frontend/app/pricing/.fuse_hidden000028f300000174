      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            {/* Billing Toggle */}
            <div className="inline-flex items-center gap-3 p-1 rounded-xl bg-[var(--bg-surface)] border border-[var(--border-main)]">
              <button
          ...
          <div className="space-y-4">
            {faqs.map((faq, index) => (
              <Card key={index} padding="none" className="overflow-hidden">
                ...
                >
                  <div className="flex items-center gap-3">
                    <HelpCircle className="h-5 w-5 text-primary-600 dark:text-primary-400 flex-shrink-0" />
