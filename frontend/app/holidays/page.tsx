  ...
  return (
    <AppLayout activeMenuItem="holidays">
      <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-4">
            ...
            {isAdmin && (
              <button
                ...
                className='flex items-center gap-2 bg-accent text-inverse px-4 py-2 rounded-lg hover:bg-accent transition-colors text-sm font-medium cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--ring-primary)] focus-visible:ring-offset-2'
              >
        ...
        {(uiError || queryError) && (
          <div
            className='mb-4 bg-status-danger-bg border border-status-danger-border text-status-danger-text px-4 py-4 rounded-lg relative'>
            <span className="block sm:inline text-sm">
              {uiError || (queryError instanceof Error ? queryError.message : 'An error occurred')}
            </span>
            <button
              onClick={() => setUiError(null)}
              className='absolute top-0 bottom-0 right-0 px-4 py-4 text-status-danger-text cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--ring-primary)] focus-visible:ring-offset-2'
                ...
                <div key={month} className="p-6">
                  ...
                  <div className="space-y-2">
                    {(holidaysByMonth[month] ?? []).map((holiday) => (
                      <div
                        key={holiday.id}
                        className={`row-between p-4 rounded-lg transition-colors ${
                      ...
                      >
                        <div className="flex items-center gap-4 flex-1 min-w-0">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            {holiday.description && (
                              <div className="text-body-secondary mt-0.5 truncate">
                                {holiday.description}
                              </div>
                            )}
                            <div className="flex flex-wrap gap-2 mt-2">
                              ...
                              {holiday.isOptional && (
                                <span
                                  className='px-2 py-0.5 text-xs font-medium rounded bg-status-warning-bg text-status-warning-text'>
                                  Optional
                                </span>
                              )}
                        ...
                        {isAdmin && (
                          <div className="flex items-center gap-1 ml-4">
                            <button
                              ...
                              className='p-2 rounded-md text-[var(--text-muted)] hover:text-accent hover:bg-accent-subtle transition-colors cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--ring-primary)] focus-visible:ring-offset-2'
                              title="Edit holiday"
                            ...
                            <button
                              ...
                              className='p-2 rounded-md text-[var(--text-muted)] hover:text-status-danger-text hover:bg-status-danger-bg transition-colors cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--ring-primary)] focus-visible:ring-offset-2'
                ...
                <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6">
                    ...
                    <div className="space-y-4">
                      <label className="flex items-center cursor-pointer">
                        <input
                          ...
                          className='h-4 w-4 text-accent focus:ring-accent-500 border-[var(--border-main)] rounded'
                        />
                  ...
                  <div className="flex justify-end gap-4 pt-4 border-t border-[var(--border-subtle)]">
                    ...
                    <button
                      ...
                      className='px-4 py-2 bg-accent text-inverse rounded-lg hover:bg-accent disabled:opacity-50 transition-colors text-sm font-medium cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--ring-primary)] focus-visible:ring-offset-2'
                    >
