...
import {Loader2, FlagTriangleRight, ArrowRight} from 'lucide-react';
        ...
        <CardContent className="py-10">
          <div className="flex items-start gap-4">
            ...
            <div className="space-y-1">
              <p className="text-sm font-semibold text-[var(--text-primary)]">Goals moved</p>
              <p className="text-caption">
                You are being redirected to the current goals workspace.
              </p>
            </div>
          </div>
          <Link
