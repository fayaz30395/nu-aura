        ...
        <div className="h-[300px]">
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={chartData}>
              ...
              <Legend/>
              <Area type="monotone" dataKey="attritionRate" name="Total Attrition %" stroke="var(--chart-danger)"
                    fill="var(--chart-danger)" fillOpacity={0.125} strokeWidth={2}/>
              <Area type="monotone" dataKey="voluntaryRate" name="Voluntary %" stroke="var(--chart-warning)"
                    fill="var(--chart-warning)" fillOpacity={0.125} strokeWidth={2}/>
              <Area type="monotone" dataKey="hiringRate" name="Hiring Rate %" stroke="var(--chart-success)"
                    fill="var(--chart-success)" fillOpacity={0.125} strokeWidth={2}/>
            </AreaChart>
          </ResponsiveContainer>
        </div>
      </CardContent>
        ...
        <div className="h-[300px]">
          <ResponsiveContainer width="100%" height="100%">
            <LineChart data={chartData}>
              ...
              <Tooltip content={<CustomTooltip/>}/>
              <Legend/>
              <Line type="monotone" dataKey="headcount" name="Headcount" stroke={chartColors.primary()} strokeWidth={2}
                    dot={{r: 3}}/>
            </LineChart>
          </ResponsiveContainer>
        </div>
        ...
        <div className="h-[300px]">
          <ResponsiveContainer width="100%" height="100%">
            <LineChart data={chartData}>
              ...
              <Tooltip content={<CustomTooltip/>}/>
              <Legend/>
              <Line type="monotone" dataKey="engagement" name="Engagement Score" stroke={chartColors.primary()}
                    strokeWidth={2} dot={{r: 3}}/>
              <Line type="monotone" dataKey="performance" name="Performance Rating" stroke={chartColors.success()}
                    strokeWidth={2} dot={{r: 3}}/>
            </LineChart>
          </ResponsiveContainer>
        </div>
        ...
        <div className="h-[300px]">
          <ResponsiveContainer width="100%" height="100%">
            <RadarChart data={radarData}>
              ...
              <Radar name="Risk Score" dataKey="score" stroke={chartColors.danger()} fill={chartColors.danger()}
                     fillOpacity={0.2}/>
            </RadarChart>
          </ResponsiveContainer>
        </div>
  ...
  return (
    <ResponsiveContainer width="100%" height="100%">
      <LineChart data={data}>
        <CartesianGrid strokeDasharray="3 3" stroke={chartColors.grid()}/>
        <XAxis dataKey="label" tick={{fontSize: 12, fill: 'var(--text-muted)'}}/>
        <YAxis yAxisId="left" domain={[0, 5]} tick={{fontSize: 12, fill: 'var(--text-muted)'}} label={{
          value: 'Engagement',
          angle: -90,
          position: 'insideLeft',
        ...
        <Tooltip content={<CustomTooltip/>}/>
        <Legend/>
        <Line yAxisId="left" type="monotone" dataKey="engagement" name="Engagement" stroke={chartColors.primary()}
              strokeWidth={2}/>
        <Line yAxisId="right" type="monotone" dataKey="attrition" name="Attrition %" stroke={chartColors.danger()}
