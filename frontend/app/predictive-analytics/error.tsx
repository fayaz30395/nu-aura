...
import {Home, RefreshCw, BarChart2} from 'lucide-react';
...
export default function PredictiveAnalyticsError({error, reset}: ErrorProps) {
  useEffect(() => {
    handleError(error, {source: 'predictive-analytics-error-boundary', digest: error.digest});
  }, [error]);
        ...
        <Card className="page-shell-card float-subtle">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex flex-col gap-2">
              ...
              <Button variant="outline" onClick={() => (window.location.href = '/predictive-analytics')} className="w-full">
                <BarChart2 className="mr-2 h-4 w-4"/>Back to Analytics
              </Button>
