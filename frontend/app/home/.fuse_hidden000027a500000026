            ...
            {nextHoliday ? (
              <div className="relative z-10">
                ...
                {dashboardData.holidays.length > 1 && (
                  <p className="text-xs text-brand-200 dark:text-primary-300 mt-2">+{dashboardData.holidays.length - 1} more upcoming</p>
                )}
              </div>
            ) : (
              ...
              <div className="space-y-1.5">
                {dashboardData.onLeaveToday.slice(0, 3).map((emp) => (
                  <div key={emp.employeeId} className="flex items-center gap-2">
                    <div className="w-6 h-6 rounded-full tint-info flex items-center justify-center text-brand-600 dark:text-primary-400 text-[9px] font-bold shrink-0">
                ...
                <div className="mb-3">
                  ...
                  {todayBirthdays.map((b) => (
                    <div key={b.employeeId} className="flex items-center gap-2 p-1.5 rounded-lg tint-success mb-1">
                      <div className="w-6 h-6 rounded-full tint-info flex items-center justify-center text-brand-600 dark:text-primary-400 text-[9px] font-bold">
