...
import {IconArrowLeft, IconCalendar, IconCheck, IconMessageCircle, IconStarFilled,} from '@tabler/icons-react';
import {AppLayout} from '@/components/layout/AppLayout';
import {PermissionGate} from '@/components/auth/PermissionGate';
import {Permissions} from '@/lib/hooks/usePermissions';
import {useConductExitInterview, useCreateExitInterview, useExitProcess,} from '@/lib/hooks/queries/useExit';
import type {ExitInterview} from '@/lib/types/hrms/exit';
import {InterviewMode, InterviewStatus, LeavingReason,} from '@/lib/types/hrms/exit';
...
export default function ExitInterviewPage() {
  ...
  const handleConductInterview = async (data: FeedbackFormData) => {
    ...
    try {
      ...
      notifications.show({
        title: 'Recorded',
        message: 'Exit interview feedback recorded',
        color: 'green',
        icon: <IconCheck size={16}/>
      });
      setMode('view');
                        ...
                        <>
                          ...
                          <SimpleGrid cols={{base: 1, sm: 3}} spacing="md">
                            ...
                            <div>
                              ...
                              <Text
                                fw={500}>{interview.newSalaryIncreasePercentage != null ? `${interview.newSalaryIncreasePercentage}%` : '-'}</Text>
                            </div>
                          </SimpleGrid>
                        </>
                      )}
