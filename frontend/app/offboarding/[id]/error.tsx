...
export default function SeparationDetailError({ error, reset }: ErrorProps) {
  useEffect(() => {
    handleError(error, { source: 'separation-detail-error-boundary', digest: error.digest });
  }, [error]);
