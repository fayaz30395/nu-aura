  ...
  return (
    <AppLayout>
      <PermissionGate anyOf={[Permissions.EXIT_VIEW, Permissions.EXIT_MANAGE]}
                      fallback={<Stack p="md"><Text c="red">You do not have permission to view separation
                        details.</Text></Stack>}>
        <Stack gap="lg" p="md">
          {/* Header */}
          ...
          <SimpleGrid cols={{base: 1, sm: 2, md: 4}} spacing="md">
            ...
            <Paper withBorder p="md" radius="md" className="bg-[var(--bg-card)]">
              <Group gap="xs" mb="xs">
                <IconCurrencyRupee size={16} className='text-accent'/>
            ...
            <Tabs.Panel value="overview" pt="md">
              <SimpleGrid cols={{base: 1, md: 2}} spacing="md">
                ...
                <Paper withBorder p="md" radius="md">
                  ...
                  <div className='w-full bg-elevated rounded-full h-3 mb-2'>
                    <div
                      className='bg-accent h-3 rounded-full transition-all duration-500'
                      style={{width: `${clearanceProgress}%`}}
                    />
                  </div>
                  <Text size="sm" c="dimmed">{clearanceProgress}% complete
                    ({approvedClearances.length} of {clearanceList.length} departments cleared)</Text>
                </Paper>
                    ...
                    <Table.Tbody>
                      {assetList.map((asset) => (
                        <Table.Tr key={asset.id}>
                          ...
                          <Table.Td>
                            <Text
                              size="sm">{asset.conditionOnReturn ? formatLabel(asset.conditionOnReturn) : '-'}</Text>
                          </Table.Td>
                          <Table.Td>
              ...
              {settlement ? (
                <Stack gap="md">
                  ...
                  <SimpleGrid cols={{base: 1, md: 3}} spacing="md">
                    ...
                    <Paper withBorder p="md" radius="md" className='bg-accent-subtle'>
