...
const fnfFormSchema = z.object({
  ...
  noticePeriodRecovery: z.coerce.number().min(0).default(0),
  reimbursements: z.coerce.number().min(0).default(0),
  otherEarnings: z.coerce.number().min(0).default(0),
  noticeBuyout: z.coerce.number().min(0).default(0),
  loanRecovery: z.coerce.number().min(0).default(0),
  advanceRecovery: z.coerce.number().min(0).default(0),
  assetDamageDeduction: z.coerce.number().min(0).default(0),
  ...
  lastDrawnSalary: z.coerce.number().min(0).optional(),
