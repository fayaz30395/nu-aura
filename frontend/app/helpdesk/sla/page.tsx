...
const slaFormSchema = z.object({
  ...
  firstResponseMinutes: z.coerce.number().min(1, 'Must be >= 1'),
  resolutionMinutes: z.coerce.number().min(1, 'Must be >= 1'),
  escalationAfterMinutes: z.coerce.number().min(1, 'Must be >= 1').optional(),
  businessStartHour: z.coerce.number().min(0).max(23),
  businessEndHour: z.coerce.number().min(0).max(23),
