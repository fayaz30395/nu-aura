...
export default function KnowledgeError({error, reset}: ErrorProps) {
  useEffect(() => {
    handleError(error, {source: 'knowledge-error-boundary', digest: error.digest});
  }, [error]);
        ...
        <Card className="page-shell-card float-subtle">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex flex-col gap-2">
              ...
              <Button variant="outline" onClick={() => (window.location.href = '/knowledge')} className="w-full">
                <BookOpen className="mr-2 h-4 w-4"/>Back to Knowledge
              </Button>
