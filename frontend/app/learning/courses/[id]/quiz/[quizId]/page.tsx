...
export default function QuizPage() {
  ...
  const startQuizMutation = useMutation({
    ...
    onError: (err: unknown) => {
      ...
      })?.response?.data?.message || 'Failed to start quiz');
    },
  });
          ...
          <div className="flex-1 p-6">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="skeuo-card p-6 mb-6">
                <h4 className="font-semibold text-[var(--text-primary)] mb-4">Questions
                  ({questionsAnswered}/{quiz.questions.length} answered)</h4>
                        ...
                        <div key={idx}
                          ...
                          <div className="flex items-start gap-4">
                            ...
                            <div className="flex-1">
                              ...
                              <p className="text-body-secondary mt-1">Your answer: <span
