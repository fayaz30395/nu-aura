          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <PermissionGate permission={Permissions.LOAN_CREATE}>
              <button
                ...
                disabled={isLoading}
                aria-busy={isLoading}
                className="flex-1 flex items-center justify-center gap-2 px-6 py-4 bg-accent-600 hover:bg-accent-700 text-white rounded-xl font-medium transition-all duration-200 disabled:opacity-50 cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--ring-primary)] focus-visible:ring-offset-2"
              >
                {isLoading ? (
                  <>
