...
import {Home, RefreshCw, Activity} from 'lucide-react';
...
export default function SurveyPulseError({error, reset}: ErrorProps) {
  useEffect(() => {
    handleError(error, {source: 'surveys-pulse-error-boundary', digest: error.digest});
  }, [error]);
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex flex-col gap-2">
              ...
              <Button variant="outline" onClick={() => (window.location.href = '/surveys')} className="w-full">
                <Activity className="mr-2 h-4 w-4"/>Back to Surveys
              </Button>
