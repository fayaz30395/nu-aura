...
export default function SurveyAnalyticsError({error, reset}: ErrorProps) {
  useEffect(() => {
    handleError(error, {source: 'surveys-[id]-analytics-error-boundary', digest: error.digest});
  }, [error]);
        ...
        <Card className="page-shell-card float-subtle">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex flex-col gap-2">
              ...
              <Button variant="outline" onClick={() => (window.location.href = '/surveys')} className="w-full">
                <BarChart2 className="mr-2 h-4 w-4"/>Back to Surveys
              </Button>
