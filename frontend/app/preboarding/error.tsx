...
import { AlertTriangle, RefreshCw, Home, ClipboardCheck } from 'lucide-react';
...
export default function PreboardingError({ error, reset }: ErrorProps) {
  useEffect(() => {
    handleError(error, { source: 'preboarding-error-boundary', digest: error.digest });
  }, [error]);
        ...
        <Card className="w-full max-w-md bg-white dark:bg-surface-900">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex flex-col gap-2">
              ...
              <Button
                variant="outline"
                onClick={() => (window.location.href = '/preboarding')}
                className="w-full"
              >
