...
import {useCreateOnboardingProcess, useOnboardingTemplates} from '@/lib/hooks/queries/useOnboarding';
...
export default function NewOnboardingPage() {
  ...
  const handleSubmit = async (data: OnboardingFormData) => {
    ...
    try {
      ...
      setSubmitError((err as {
        response?: { data?: { message?: string } }
      })?.response?.data?.message || 'Failed to initiate onboarding');
    }
  };
                      ...
                      >
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            ...
                            <p className="text-sm font-bold text-[var(--text-muted)]">{temp.estimatedDays} Days
                              Estimated</p>
                          </div>
                        </div>
