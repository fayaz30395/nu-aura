...
export default function OnboardingPage() {
  ...
  const stats = [
    ...
    {label: 'Avg. Days', value: '12', icon: Clock, color: "text-accent", bg: "bg-[var(--accent-500)]/10"}
  ];
      ...
      <div className="max-w-7xl mx-auto space-y-6 py-4">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          ...
          <div className="flex items-center gap-4">
            <PermissionGate permission={Permissions.ONBOARDING_MANAGE}>
              <Button
                variant="outline"
                className="btn-secondary font-black tracking-widest uppercase text-xs rounded-lg"
        ...
        <div className="space-y-6">
          <Card className="card-aura border-0 shadow-[var(--shadow-elevated)] overflow-hidden">
            <div
              className="p-6 border-b border-[var(--border-main)] flex flex-col md:flex-row gap-6 justify-between items-center">
              <div className="relative w-full md:w-1/3">
                ...
                <Input
                  ...
                  className="input-aura pl-12 rounded-lg font-bold"
                  value={searchQuery}
              ...
              <div className="flex items-center gap-4 w-full md:w-auto">
                <div
                  className="flex items-center gap-2 bg-[var(--bg-input)] px-4 py-2 rounded-lg border border-white/20">
            ...
            <div className="divide-y divide-[var(--border-main)]/50">
              {isLoading ? (
                ...
                <div className="p-20 text-center">
                  ...
                  <p className="text-[var(--text-muted)] font-bold mt-2">Adjust your filters or initiate a new
                    onboarding.</p>
                </div>
              ) : (
                <AnimatePresence>
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6">
                        ...
                        <div className="row-between sm:justify-end gap-10">
                          <div className="text-right hidden sm:block">
                            <span
                              className="text-xs font-black uppercase tracking-widest text-[var(--text-muted)] block mb-2">Momentum</span>
                            <div className="flex items-center gap-4">
                              <div
                                className="w-32 h-2.5 bg-[var(--bg-secondary)] rounded-full overflow-hidden shadow-inner">
                                <motion.div
                                  initial={{width: 0}}
