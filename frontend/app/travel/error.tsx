...
import { AlertTriangle, RefreshCw, Home, Plane } from 'lucide-react';
...
export default function TravelError({ error, reset }: ErrorProps) {
  useEffect(() => {
    handleError(error, { source: 'travel-error-boundary', digest: error.digest });
  }, [error]);
