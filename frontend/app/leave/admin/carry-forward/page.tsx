      ...
      >
        <div className="p-6 max-w-xl mx-auto">
          ...
          <div className="skeuo-card p-6 space-y-6">
            ...
            <div
              className="flex items-center gap-4 p-4 bg-accent-50 dark:bg-accent-950/30 rounded-lg border border-accent-200 dark:border-accent-800">
          ...
          {result && (
            <div
              className="mt-6 skeuo-card p-6 border border-success-200 dark:border-success-800 bg-success-50 dark:bg-success-900/20">
