  ...
  return (
    <AppLayout activeMenuItem="leave">
      <PermissionGate
        ...
        fallback={
          <div className="p-6">
            <p className='text-status-danger-text'>You do not have permission to view this page.</p>
          </div>
        }
      >
        <div className="p-6 max-w-2xl mx-auto">
          ...
          {isLoading ? (
            ...
            <form onSubmit={handleSubmit((data) => encashMutation.mutate(data))}
                  className="skeuo-card p-6 space-y-6 border border-[var(--border-main)] rounded-xl">
              <div>
                ...
                {errors.leaveBalanceId && (
                  <p className='text-status-danger-text text-xs mt-1'>{errors.leaveBalanceId.message}</p>
                )}
              </div>
              ...
              <div>
                ...
                />
                {errors.daysToEncash && (
                  <p className='text-status-danger-text text-xs mt-1'>{errors.daysToEncash.message}</p>
                )}
              </div>
