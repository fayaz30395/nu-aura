...
export default function AdminPayrollError({error, reset}: ErrorProps) {
  useEffect(() => {
    handleError(error, {source: 'admin-payroll-error-boundary', digest: error.digest});
  }, [error]);
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex flex-col gap-2">
              ...
              <Button variant="outline" onClick={() => (window.location.href = '/admin')} className="w-full">
                <CreditCard className="mr-2 h-4 w-4"/>Back to Admin
              </Button>
