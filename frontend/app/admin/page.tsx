    ...
    <AdminPageContent className="p-4 md:p-6 lg:p-8">
      ...
      >
        ...
        <div className="skeuo-card rounded-xl border border-[var(--border-main)]">
          <div
            className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 px-4 py-4 border-b border-[var(--border-main)]">
            <div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="md:col-span-2">
              <label
                className="block text-xs font-medium text-[var(--text-secondary)] dark:text-[var(--text-muted)] mb-1">
                User Email
              </label>
              <input
                type="email"
    ...
    >
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 relative z-10">
        ...
        <div className="flex items-center gap-4">
          ...
          >
            <svg className={`w-4 h-4 text-[var(--text-secondary)] ${isLoading ? 'animate-spin' : ''}`}
...
function Th({children}: { children: React.ReactNode }) {
  return (
    <th
      className="skeuo-table-header px-6 py-2 text-left text-xs font-semibold text-[var(--text-muted)] uppercase tracking-wider">
      {children}
    </th>
  );
}
