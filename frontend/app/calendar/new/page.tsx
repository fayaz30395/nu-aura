    ...
    <AppLayout activeMenuItem="calendar">
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-xl font-bold text-[var(--text-primary)]">New Event</h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <PermissionGate permission={Permissions.CALENDAR_CREATE}>
              <button
                type="submit"
                disabled={isLoading}
                className="flex-1 flex items-center justify-center gap-2 px-6 py-4 bg-accent-600 hover:bg-accent-700 text-white rounded-xl font-medium transition-all duration-200 disabled:opacity-50"
              >
                {isLoading ? (
                  <>
