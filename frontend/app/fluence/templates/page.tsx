                ...
                <Card className={`${dsCard.interactive} h-full flex flex-col group`}>
                  <CardHeader>
                    <div className="flex items-start justify-between gap-2 mb-3">
                      <div className="w-10 h-10 rounded-lg bg-[var(--primary-100)] dark:bg-[var(--primary-900)]/30 flex items-center justify-center flex-shrink-0 group-hover:bg-[var(--primary-200)] dark:group-hover:bg-[var(--primary-800)]/40 transition-colors duration-150">
                        {template.icon ? (
                          <span className="text-xl">{template.icon}</span>
                        ) : (
                          <FileText className={`${iconSize.cardInline} text-[var(--primary-700)] dark:text-[var(--primary-300)]`} />
                        )}
                      </div>
                      <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-[var(--primary-100)] dark:bg-[var(--primary-900)]/30 text-[var(--primary-700)] dark:text-[var(--primary-300)] text-xs font-semibold whitespace-nowrap">
