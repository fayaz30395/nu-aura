        ...
        <div className="fluence-page-topbar">
          ...
          <div className="fluence-page-topbar-right">
            ...
            <button
              type="button"
              onClick={() => setPublishDrawerOpen(true)}
              className="inline-flex items-center gap-2 text-sm font-medium text-white bg-primary-600 hover:bg-primary-700 px-4 py-2 rounded-lg transition-colors shadow-sm"
            >
                    ...
                    <div className="space-y-1">
                      {VISIBILITY_OPTIONS.map((opt) => {
                        ...
                        return (
                          ...
                          >
                            <Icon className={`w-4 h-4 ${isSelected ? 'text-primary-500' : 'text-[var(--text-muted)]'}`} />
                            <div className="flex-1">
                              <div className={`text-sm font-medium ${isSelected ? 'text-primary-500' : 'text-[var(--text-primary)]'}`}>
                                {opt.label}
                              </div>
                              <div className="text-xs text-[var(--text-muted)]">{opt.desc}</div>
                            </div>
                            {isSelected && (
                              <motion.div layoutId="visibility-check" className="w-2 h-2 rounded-full bg-primary-500" />
                            )}
                          </button>
                        );
                      })}
