...
export default function Loading() {
  return (
    <div className="page-shell-centered fade-slide-up auth-delay-20 p-4 sm:p-6 space-y-6">
      {/* Header skeleton */}
      ...
      <div className="rounded-lg border border-surface-200 dark:border-surface-800 p-4 sm:p-6 space-y-4">
