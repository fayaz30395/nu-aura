...
import { AlertTriangle, RefreshCw, Home, Award } from 'lucide-react';
...
export default function RecognitionError({ error, reset }: ErrorProps) {
  useEffect(() => {
    handleError(error, { source: 'recognition-error-boundary', digest: error.digest });
  }, [error]);
