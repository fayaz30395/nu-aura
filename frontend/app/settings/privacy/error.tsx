...
export default function SettingsPrivacyError({error, reset}: ErrorProps) {
  useEffect(() => {
    handleError(error, {source: 'settings-privacy-error-boundary', digest: error.digest});
  }, [error]);
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex flex-col gap-2">
              ...
              <Button variant="outline" onClick={() => (window.location.href = '/settings')} className="w-full">
                <Shield className="mr-2 h-4 w-4"/>Back to Settings
              </Button>
