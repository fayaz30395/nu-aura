...
export default function TimeTrackingEditError({error, reset}: ErrorProps) {
  useEffect(() => {
    handleError(error, {source: 'time-tracking-[id]-edit-error-boundary', digest: error.digest});
  }, [error]);
        ...
        <Card className="page-shell-card float-subtle">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex flex-col gap-2">
              ...
              <Button variant="outline" onClick={() => (window.location.href = '/time-tracking')} className="w-full">
                <Clock className="mr-2 h-4 w-4"/>Back to Time Tracking
              </Button>
