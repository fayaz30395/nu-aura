  ...
  return (
    <div className="p-6 space-y-6 animate-pulse">
      ...
      <div className="flex gap-1 border-b border-[var(--border-main)] pb-0">
        {[...Array(5)].map((_, i) => (
          <div key={i} className={`h-9 rounded-t px-4 ${i === 0 ? 'bg-gray-200 w-28' : 'bg-[var(--bg-surface)] w-24'}`} />
        ))}
      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {[...Array(4)].map((_, i) => (
          <div key={i} className="bg-white border border-[var(--border-main)] rounded-lg p-5 space-y-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {[...Array(2)].map((_, i) => (
          <div key={i} className="bg-white border border-[var(--border-main)] rounded-lg p-5 space-y-4">
