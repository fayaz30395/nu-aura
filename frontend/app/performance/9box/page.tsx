              ...
              <div className="bg-[var(--bg-input)] border border-[var(--border-main)] rounded-lg p-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xl font-bold text-[var(--text-primary)]">{points.length}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-[var(--bg-input)] border border-[var(--border-main)] rounded-lg p-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xl font-bold text-[var(--text-primary)]">{stats.stars}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-[var(--bg-input)] border border-[var(--border-main)] rounded-lg p-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xl font-bold text-[var(--text-primary)]">{stats.highPerformers}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-[var(--bg-input)] border border-[var(--border-main)] rounded-lg p-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xl font-bold text-[var(--text-primary)]">{stats.highPotential}</p>
                  </div>
                </div>
              </div>
            </div>
