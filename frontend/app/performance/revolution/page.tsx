        ...
        <AppLayout activeMenuItem="performance">
            <div className="p-6 space-y-8 max-w-[1600px] mx-auto">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div>
                        <h1 className="text-3xl font-bold skeuo-emboss bg-clip-text text-transparent bg-gradient-to-r from-accent-700 to-accent-600 dark:from-accent-400 dark:to-accent-400">
