      ...
      <PermissionGate permission={Permissions.REVIEW_VIEW} fallback={
        ...
        <div className="p-6 space-y-8 max-w-[1600px] mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <Card
              className="lg:col-span-8 overflow-hidden bg-[var(--bg-secondary)] border-none text-white relative h-[600px]">
              <div
            ...
            <Card className="lg:col-span-4 bg-[var(--bg-card)]">
              ...
              <CardContent>
                ...
                <div className="flex justify-center gap-4 mt-6">
                  <div className="flex items-center gap-1.5">
                    <div className="w-3 h-1.5 rounded-full bg-success-500"/>
                    <span className="text-xs">Self</span></div>
                  <div className="flex items-center gap-1.5">
                    <div className="w-3 h-1.5 rounded-full bg-accent-700"/>
                    <span className="text-xs">Peers</span></div>
                  <div className="flex items-center gap-1.5">
                    <div className="w-3 h-1.5 rounded-full bg-accent-500"/>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            {/* Coaching Corner */}
            <Card
              className="md:col-span-2 bg-gradient-to-br from-accent-50 to-white dark:from-accent-950/20 dark:to-surface-900">
              <CardHeader>
                <div className="row-between">
