...
import {Home, RefreshCw, Grid} from 'lucide-react';
...
export default function CompetencyMatrixError({error, reset}: ErrorProps) {
  useEffect(() => {
    handleError(error, {source: 'performance-competency-matrix-error-boundary', digest: error.digest});
  }, [error]);
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex flex-col gap-2">
              ...
              <Button variant="outline" onClick={() => (window.location.href = '/performance')} className="w-full">
                <Grid className="mr-2 h-4 w-4"/>Back to Performance
              </Button>
