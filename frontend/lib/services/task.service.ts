...
export const taskService = {
  ...
  getPriorityBadge(priority: TaskPriority): { bg: string; text: string } {
    const badges: Record<TaskPriority, { bg: string; text: string }> = {
      LOW: { bg: 'bg-gray-100 dark:bg-surface-800', text: 'text-gray-600 dark:text-gray-400' },
  ...
  getStatusBadge(status: TaskStatus): { bg: string; text: string } {
    const badges: Record<TaskStatus, { bg: string; text: string }> = {
      BACKLOG: { bg: 'bg-gray-100 dark:bg-surface-800', text: 'text-gray-700 dark:text-gray-300' },
      ...
      CANCELLED: { bg: 'bg-gray-200 dark:bg-surface-700', text: 'text-gray-500 dark:text-gray-400' },
    };
