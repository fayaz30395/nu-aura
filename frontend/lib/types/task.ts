...
export const TASK_STATUS_OPTIONS: { value: TaskStatus; label: string; color: string }[] = [
  { value: 'BACKLOG', label: 'Backlog', color: 'bg-gray-100 text-gray-700 dark:bg-gray-800 dark:text-gray-300' },
  ...
  { value: 'CANCELLED', label: 'Cancelled', color: 'bg-gray-200 text-gray-500 dark:bg-gray-700 dark:text-gray-400' },
];
