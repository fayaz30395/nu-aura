...
const CATEGORY_COLORS: Record<ExpenseCategory, string> = {
  TRAVEL: 'var(--chart-primary)',
  ACCOMMODATION: 'var(--chart-secondary)',
  MEALS: 'var(--chart-warning)',
  TRANSPORT: 'var(--chart-success)',
  OFFICE_SUPPLIES: 'var(--chart-info)',
  EQUIPMENT: 'var(--chart-accent)',
  SOFTWARE: 'var(--chart-success)',
  TRAINING: 'var(--chart-primary)',
  COMMUNICATION: 'var(--chart-warning)',
  ENTERTAINMENT: 'var(--chart-secondary)',
  MEDICAL: 'var(--chart-danger)',
  RELOCATION: 'var(--chart-secondary)',
  ...
  const categoryData = useMemo<CategoryData[]>(() => {
    ...
    return Object.entries(totals)
      .map(([category, data]) => ({
        ...
        color: CATEGORY_COLORS[category as ExpenseCategory] || 'var(--chart-muted)',
      }))
