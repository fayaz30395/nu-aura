      ...
      <div className="relative flex-1 min-w-[200px] max-w-sm">
        ...
        {searchQuery && (
          <button
            ...
            className="absolute right-2 top-1/2 -translate-y-1/2 h-5 w-5 rounded-full bg-slate-200 dark:bg-slate-700 flex items-center justify-center text-[var(--text-secondary)] hover:bg-slate-300 dark:hover:bg-slate-600 transition-colors"
