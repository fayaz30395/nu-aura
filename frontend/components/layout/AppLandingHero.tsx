...
export const AppLandingHero: React.FC<AppLandingHeroProps> = ({
  ...
  return (
    <div
      className="relative min-h-[60vh] flex flex-col items-center justify-center text-center px-4 py-12 overflow-hidden">
      ...
      >
        {/* Icon */}
        <motion.div
          className={`${iconDimensions[iconSize]} rounded-lg bg-gradient-to-br ${gradientFrom} ${gradientTo} flex items-center justify-center shadow-[var(--shadow-dropdown)] mb-6 mx-auto`}
