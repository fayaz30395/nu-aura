...
const icon = {
  ...
  zap: <Zap className="h-5 w-5 text-warning-500"/>,
  ...
  activity: <Activity className="h-5 w-5 text-accent-500"/>,
  ...
  return [
    ...
    // at the page level and backend enforces that users can only see their own data.
    {
      ...
      items: [
        ...
        {id: 'my-assets', label: 'My Assets', icon: icon.package, href: '/me/assets'},
      ],
    },
    ...
    // ─── 4. HR OPERATIONS ───────────────────────────────────────────
    {
      ...
      items: [
        ...
        },
        {
          ...
          children: [
            ...
            },
            {
              ...
              href: '/leave/apply',
              icon: sm.send,
              requiredPermission: Permissions.LEAVE_APPLY
            },
            {
              id: 'leave-approvals',
        ...
        },
        {
          ...
          icon: icon.timer,
          href: '/overtime',
          requiredPermission: Permissions.OVERTIME_VIEW
        },
        {
          id: 'probation',
          label: 'Probation',
          icon: icon.userCheck,
          href: '/probation',
          requiredPermission: Permissions.PROBATION_VIEW
        },
        {
          id: 'assets',
          label: 'Assets',
        ...
        },
        {
          ...
          icon: icon.fileText,
          href: '/contracts',
          requiredPermission: Permissions.CONTRACT_VIEW
        },
      ],
    },
      ...
      items: [
        {
          ...
          children: [
            ...
            },
            {
              ...
              icon: sm.users,
              requiredPermission: Permissions.CANDIDATE_VIEW
            },
            {
        ...
        },
        {
          ...
          icon: icon.userCheck,
          href: '/onboarding',
          requiredPermission: Permissions.ONBOARDING_VIEW,
          children: [
            {
              id: 'onboarding-overview-hire',
              label: 'Overview',
              href: '/onboarding',
              icon: sm.dashboard,
              requiredPermission: Permissions.ONBOARDING_VIEW
        ...
        },
        {
          ...
          icon: icon.share2,
          href: '/referrals',
          requiredPermission: Permissions.REFERRAL_VIEW
        },
      ],
    },
    // ─── NU-Grow Hub ────────────────────────────────────────────────
    {
      ...
      items: [
        ...
        {
          id: 'performance-revolution-grow',
          label: 'Revolution',
          icon: icon.zap,
          href: '/performance/revolution',
          requiredPermission: Permissions.REVIEW_VIEW
        ...
        },
        {
          ...
          icon: icon.users,
          href: '/one-on-one',
          requiredPermission: Permissions.MEETING_VIEW
        },
        {
          id: 'training-grow',
          label: 'Training',
    ...
    // ─── 6. PAY & FINANCE ───────────────────────────────────────────
    {
      ...
      items: [
        ...
        },
        {
          ...
          icon: icon.gift,
          href: '/benefits',
          requiredPermission: Permissions.BENEFIT_VIEW_SELF
        },
        {
          ...
          children: [
            ...
            },
            {
              ...
              icon: sm.barChart2,
              requiredPermission: Permissions.EXPENSE_VIEW_ALL
            },
            {
              ...
              icon: sm.settings,
              requiredPermission: Permissions.EXPENSE_MANAGE
            },
          ],
        },
          ...
          children: [
            {
              ...
              href: '/loans',
              icon: sm.dashboard,
              requiredPermission: Permissions.LOAN_VIEW
            },
            {
              id: 'loans-new',
              label: 'New Loan',
              href: '/loans/new',
              icon: sm.fileText,
              requiredPermission: Permissions.LOAN_CREATE
            },
          ],
        },
        {
        ...
        },
        {
          ...
          icon: icon.scale,
          href: '/statutory',
          requiredPermission: Permissions.STATUTORY_VIEW
        },
        {
          ...
          children: [
            {
              ...
              href: '/tax',
              icon: sm.dashboard,
              requiredPermission: Permissions.TAX_VIEW
            },
            {
              id: 'tax-declarations',
              label: 'Declarations',
    ...
    // ─── 7. PROJECTS & WORKSPACE ────────────────────────────────────
    {
      ...
      items: [
        ...
        },
        {
          ...
          icon: icon.mail,
          href: '/nu-mail',
          requiredPermission: Permissions.EMAIL_VIEW
        },
      ],
    },
    // ─── 8. REPORTS & ANALYTICS ─────────────────────────────────────
    ...
    // ─── 9. ADMIN & SETTINGS ────────────────────────────────────────
    {
      ...
      items: [
        ...
        },
        {
          ...
          href: '/import-export',
          requiredPermission: Permissions.MIGRATION_IMPORT
        },
        {
          id: 'integrations',
          label: 'Integrations',
        ...
        },
        {
          ...
          href: '/helpdesk',
          requiredPermission: Permissions.HELPDESK_TICKET_VIEW,
          children: [
            {
              id: 'helpdesk-tickets',
              label: 'Tickets',
