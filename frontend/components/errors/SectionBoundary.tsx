...
function SectionErrorFallback({error, onReset, sectionName}: SectionErrorFallbackProps) {
  return (
    <div className="flex items-center gap-4 p-4 rounded-lg border border-[var(--border-main)] bg-[var(--bg-card)]">
      <div
        className='flex-shrink-0 w-10 h-10 rounded-full bg-status-danger-bg flex items-center justify-center'>
        <svg className='w-5 h-5 text-status-danger-text' fill="none" stroke="currentColor" viewBox="0 0 24 24">
