      ...
      <div className="flex-1">
        ...
        <div className="mt-2 flex items-center gap-4">
          <button
            ...
            className="inline-flex items-center gap-1 text-xs font-medium text-[var(--text-muted)] hover:text-accent-700 dark:hover:text-accent-400"
          >
    ...
    <div className="space-y-4">
      ...
      {hasMore && !isLoading && (
        <motion.button
          ...
          animate={{ opacity: 1 }}
          onClick={onLoadMore}
          className="text-center text-sm font-medium text-accent-700 hover:text-accent-700 dark:text-accent-400 dark:hover:text-accent-300"
        >
          Load more comments
        </motion.button>
      )}
          ...
          >
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="text-xs text-accent-700 hover:text-accent-700 dark:text-accent-400 dark:hover:text-accent-300"
              >
                Cancel
              </button>
            </div>
