...
const variantConfig: Record<Exclude<StatCardVariant, 'premium'>, VariantStyle> = {
  ...
  primary: {
    ...
    border: "border-[var(--accent-200)]/50",
    iconBg: "bg-[var(--accent-500)]/10",
  ...
  success: {
    ...
    border: "border-[var(--success-200)]/50",
    iconBg: "bg-[var(--success-500)]/10",
  ...
  warning: {
    ...
    border: "border-[var(--warning-200)]/50",
    iconBg: "bg-[var(--warning-500)]/10",
  ...
  destructive: {
    ...
    border: "border-[var(--danger-200)]/50",
    iconBg: "bg-[var(--danger-500)]/10",
