...
const variantConfig = {
  primary: {
    outer: 'stroke-primary-200 dark:stroke-primary-900',
...
export function PulseRing({ size = 'md', variant = 'primary', className }: SpinnerProps) {
  ...
  const ringColors = {
    primary: 'border-primary-600/20 dark:border-primary-400/20',
    secondary: 'border-gray-600/20 dark:border-gray-400/20',
