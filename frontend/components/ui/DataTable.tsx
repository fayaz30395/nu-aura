...
const variantStyles: Record<string, string> = {
  primary:
    'bg-sky-700 hover:bg-sky-800 text-white focus:ring-sky-700',
  danger:
    'bg-red-600 hover:bg-red-700 text-white focus:ring-red-600',
  secondary:
    'border border-[var(--border-main)] bg-[var(--bg-surface)] text-[var(--text-primary)] hover:bg-[var(--bg-secondary)] focus:ring-sky-700',
};
              ...
              return (
                <tr
                  ...
                  className={cn(
                    ...
                    isSelected && 'bg-sky-50 dark:bg-sky-900/10'
                  )}
                >
                  {/* Selection checkbox */}
                  {selectable && (
                    <td className="w-12 px-4 py-3 sticky left-0 z-10 bg-inherit">
                      <div className="flex items-center justify-center">
                        <input
                          type="checkbox"
                          checked={isSelected}
